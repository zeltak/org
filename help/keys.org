...
| Keys    | comment                                                               | function                                           | tag            |
|---------+-----------------------------------------------------------------------+----------------------------------------------------+----------------|
| Space   | Display the original location of the item in another window           | org-agenda-show-and-scroll-up                      | agenda, buffer |
| TAB     | goto the original location of the item in another window              | org-agenda-goto                                    | agenda, buffer |
...
| j       | goto date                                                             | tagtagtag                                          | agenda, buffer |
| */*     | filter by tag1                                                        |                                                    | agenda, buffer |
| t       | change todo State                                                     | org,F9org,F9org,F9org-agenda-todo                  | agenda, buffer |
...
| x       | Exit agenda, remove the agenda buffer and all buffers loaded by Emacs | org-agenda-exit                                    | agenda, buffer |
|         |                                                                       |                                                    | agenda, buffer |
|---------+-----------------------------------------------------------------------+----------------------------------------------------+----------------|
