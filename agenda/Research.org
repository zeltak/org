...
*** NEXT Future models ideas
    :PROPERTIES:
    :ID:       ac4983ec-5425-4d68-8451-a44507f56427
    :END:
**** TODO IDEAs
     :PROPERTIES:
     :ID: a0658698-7ca9-4cea-8967-ba138950eb22
     :END:
comparing the wrf model in paris
use calman filte to merge 1x1km to 3x3km
take interactions with wind 
random slope for each slopes for each wind direction
use wind speed to choose the best 9 grid cell 
aod 
...
**** NEXT supplementing AOD by space and time
     :PROPERTIES:
...
**** NEXT Try removing (in mod1&2) aodid gridcells that have very few passable days (<100) :newdata:
     :PROPERTIES:
...
*** NEXT hows brents student doing with the decomposing local pm project
    ...
    :END:
*** NEXT As part of multi exposure project. do you think there is any interest in putting effort to the following:
    :PROPERTIES:
...
O3 
Is worth having models

o3 And light at night
...
*** NEXT mee-hyees model state?
    :PROPERTIES:
    :ID:       c988c85d-302d-4c74-b91a-f17b2ebacaca
    :END:
*** NEXT Israel model state
    :PROPERTIES:
...
PICKS UP SEND - maybe thats why PM 10 is better
*** NEXT $$ for travel from Haifa project and EHF (if granted). we may be able to do a little trick to maybe get ronnie a ticket..ill talk to boris.
    :PROPERTIES:
    :ID:       cdbb4e4c-7016-4e70-9dfd-c0be81ef8a45
    :END:
*** NEXT still have BW paper in EHP, DVT is under review
    :PROPERTIES:
    :ID:       edc6bba0-ce72-4048-9764-ef729f874a05
    :END:
*** NEXT will start in following week to work on france temperature paper taking over from francesco
    :PROPERTIES:
...
*** light at night in goeorgis we have mortality data 
*** NEXT alexei-black body radiation. black particles are going to observer and scatter roughly the same ammount vs other particles wont. it might be possible in NEW-England at least to use that information on how to use the diff on wave lenghts in aod for BC model.
    :PROPERTIES:
