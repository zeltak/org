...
- ehf workshops with mark in Julym offer to cover tickets regardless of our grant
-israel model works but CV R2 0.69 (from 0.80 non cv)
we tried mean aod, aod prev-post
pm-pre post works well (excluding actual mon) but then mod 2 would be a problem
