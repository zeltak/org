...
*** NEXT Kees talk
**** ask about type I vs type II for noise measurments
...
over fitting isn't the issue since also in a prasimonous model we still get this drop
...
in general raw correlations aren't great- 0.001-0.3 in good areas
there are specifc station in speific seasons that have a base correlation of 0
UN and adjancecny mask werent helping that much
