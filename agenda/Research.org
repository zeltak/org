...
*** TODO ask allan about long term analysis glmpql cells with 0       :allan:
...
**q** TODO slowly start organize data to publishable state	     :meytar:
*** explore
**** results
...
**** Joels random intercepts per cell
...
**** TODO organize a big skype call
...
**** TODO stratify corr models by humidity
...
aeronet campign
vertical profile
*** TODO explore with alexei sun photometer
*** TODO write brent about mixed model meeting
*** TODO talk to allan about the intercept vs day
*** TODO talk to josef and a grant , is it a big grant or a travel grant
...
**** TODO another paper looking at these changes and what they mean for urban planning and urban development-perhaps cobine forces there?
...
*** TODO talk to joel about specific grant 
...
*** TODO [#A] arrange meeting with joel, bangalore
* gmail recovery
...
** TODO Current Opinion in Pediatrics review paper
...
** TODO [#A] helen burress paperwork
   DEADLINE: <2015-10-15 Thu>
heburris@bidmc.harvard.edu RE: paperwork issues
** TODO check return money from HUJI which I havent recived yet
