...
teom at 50 may over measure and introduce noise to pm25.
...
any progress with data fusion for next iteration. 
geochem data for israel
what techniques are they using- kalman filter
...
**** Massimo analysis in lombardy- very encouraging CV ~ 0.8
...
** TODO make sense of all kopot gemel
   ...
   :END:
** TODO Talk to mihyee about how she proccesws MATLAB- tell her to talk to meytar
