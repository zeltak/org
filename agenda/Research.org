...
There are several things to ℅-ordinate. I am going to Mumbai for a meeting that Columbia is organizing that will be in part about air pollution in India. One piece will be using Geoschem for source apportionment. I don't know if the people you are talking to are involved in that, or interested in being involved. Can you check with them, because that may influence who we want on the call.
...
*** TODO send joel indian guy details
*** TODO new PM israel model 
