...
*** DONE send paper when ready to coauthors <2014-03-12 Wed>
    ...
    :END:
*** TODO submit DVT paper
    :PROPERTIES:
    :ID:       3d179259-c23a-40d4-bf58-471987418313
    :END:
** Greg Willenius RI temperature study <2014-03-16 Sun>
   :PROPERTIES:
...
** Joel
*** 11.6.2014
**** New iteration has new KNN algoryhtm to calculate 60km buffers so that even areas with no active PM monitors for that day in that area are supplemnted by nearby regions
**** EHP paper 
***** pm+ta in birth wieght (both mixed and reg works well)
***** in logisitcs using gee and glmpql only full birth preterm works   
**** WRF Models- for future predictions
**** Italy
...
** URBAN multi pollutant with jaime
...
** WAITING Antonella whole USA 1x1km grant
   :PROPERTIES:
...
** WAITING Andrea padwan LAN-Prostate Italian SIR grant
** R21 with Sara Adar
...
*** UPS
*** Speakers
***  מסך מחשב Dell UltraSharp P2815Q 28'' UltraHD 4Krrrrrrrrre1111111111222222222222222e2222222222222265^
*** Proffesional camera 
...
**** marketing 
***** TODO email sagi langer about geoinformatics marketing
      :PROPERTIES:
