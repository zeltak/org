...
regress PM+maiac as 
regression calibration of obs vs pred prediited
...
** TODO publications
check about monitary benefts for publications , accepted, submitted etc
that is if things like this (incentives) work for students to make them publish
should the money be awarded on start of MA or after the paper is accepted, submitted?
check other departments here and around the world to see if they offer such incentives or bonuses?
around 2000-3000 per prize per student
