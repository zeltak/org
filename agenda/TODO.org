...
* `TODO`							 
  ...
  :END:
** org-download idea
open an image in editor of choice, edit and then update the edited image in orgmode with edits
** dired issues 
...
*** explore SR change dir in other window
 https://github.com/escherdragon/sunrise-commander/blob/dd94d3da75fcef0ac11d1d008ab9081c6f80f013/sunrise-commander.el
