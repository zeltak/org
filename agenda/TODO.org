...
* `TODO` 							  :CANCELLED:
** report
nox bazan all sig variables R2 n
** org-reveal
*** justify to the left and not centered
** covert word to text for better cross academic search 
** mu4e
*** flag only view 
** Fix Dunst
** elfeed
...
** org summary from drwares
http://stackoverflow.com/questions/19510984/section-summaries-in-org-mode
...
#+RESULTS:
| --name  |          |                              |                                         |                |          |                        |      |           |
| Using   | database | /home/zeltak/.password-store |                                         |                |          |                        |      |           |
|         |          |                              |                                         |                |          |                        |      |           |
|         |          |                              |                                         |                |          |                        |      |           |
| Storing | file     | rateyourmusic                | in                                      | group          | bookmark |                        |      |           |
| mkdir:  | created  | directory                    | ‘/home/zeltak/.password-store/bookmark’ |                |          |                        |      |           |
| Enter   | contents | of                           | bookmark/rateyourmusic                  | and            | press    | Ctrl+D                 | when | finished: |
|         |          |                              |                                         |                |          |                        |      |           |
| [master | ae51b75] | Add                          | given                                   | password       | for      | bookmark/rateyourmusic | to   | store.    |
| 1       | file     | changed,                     | 0                                       | insertions(+), | 0        | deletions(-)           |      |           |
| create  | mode     | 100644                       | bookmark/rateyourmusic.gpg              |                |          |                        |      |           |
