...
** change location of unison sync files
** figure out Emacs region and mearks (vim like C-v//V)
** ask org mail
convert a simple list of lines each to a orgmode header
** check out avy-timeout-seconds settings 
** clean org file
...
** get a handle on tables (using hydra) for spreadsheet like stuff
