...
* `TODO`							 
  ...
  :END:
** disable tab in org mode headers to expand more
** add melpa search in firefox?
** academic log book?
...
** dired addon TODAY
*** dired bookmark+ combo- very powerful 
bmkp-dired-jump
https://www.emacswiki.org/emacs/BookmarkPlus

Whenever you create a bookmark in a Dired buffer (e.g. ‘C-x r m’), the current state is saved as part of the bookmark: point, the current ‘ls’ listing switches, the set of inserted subdirectories, the set of hidden directories, and the set of marked files. Whenever you jump to a Dired bookmark (e.g. ‘C-x r b’), all of these are restored.
...
*** create virtual dirs 
http://emacs.stackexchange.com/questions/7790/programmatically-add-files-to-existing-dired-buffer

add files/folders from different locations to one virtual dir. you can also  bookmark that dir perhaps?

another option is to create it in lisp
http://emacs.stackexchange.com/questions/2567/programmatically-insert-files-into-dired-buffer

#+BEGIN_SRC emacs-lisp  :results none
(dired (list "My Dired Buffer Name*"     ; The Dired buffer name
             "/home/zeltak/ZH_tmp/$Ikloog_CV_GEOG_BGU_MAR_11v2_2016.pdf"         ; First file
             "/home/zeltak/ZH_tmp/Lahav/"      ; Third is a directory
             "/home/zeltak/ZH_tmp/emily/"))   ; Fourth
#+END_SRC
*** setting value for big file warnings

	
Thank you very much! It works. BTW, when I open a mp4 file, emacs always ask me to confirm: File abc.mp4 is large (330.2M), really open? (y or n) y Can we get ride of this? – Nick Dec 29 '14 at 6:35
   	 
	
You can set the value that will trigger the warning. Here, 500MB (setq large-file-warning-threshold 500000000)
** https://github.com/ryuslash/mode-icons
** git hydra
http://emacs.stackexchange.com/questions/21597/using-magit-for-the-most-basic-add-commit-push
#+BEGIN_SRC emacs-lisp  :results none
...
** TODO Colored text in org-mode with export to HTML
...
** flip belt
   :PROPERTIES:
   :ID:       0989f1a7-7fc7-4c8f-bfe4-cd9d5d889f08
   :END:
...
** http://emacs.stackexchange.com/questions/tagged/org-mode?page=5&sort=newest&pagesize=500
** http://blog.binchen.org/posts/how-to-use-gnus-group-topics-efficiently.html
** http://pragmaticemacs.com/emacs/tweaking-email-contact-completion-in-mu4e/
** [[http://emacs.stackexchange.com/questions/21301/async-execution-in-org-babel][matlab - Async execution in org babel - Emacs Stack Exchange]]
...
** TODO http://endlessparentheses.com/running-emacs-on-android.html
*** https://termux.com/storage.html
** TODO https://plusnoise.wordpress.com/2016/04/10/emacs-on-android/
** https://oliverse.ch/tech/2016/02/16/display-output-of-a-bash-script-on-a-widget.html
