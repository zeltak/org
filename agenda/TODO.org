...
** Train back
flight leaves at 11:50 from Amsterdam and lands in 5:30
	18:35	20:11	1:36	1	[+] הצג מסלול	גישה לנכים מקומות שמורים	
	19:35	21:11	1:36	1	[+] הצג מסלול	גישה לנכים מקומות שמורים	
** mail- gmail organize, move starred to org via wl
** company mode
