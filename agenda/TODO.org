...
change to terminator from lilyterm
check patst.sh in ZH_tmp
check tarman
org habits 
** custom Emacs search and replace				       :COOK:
something like this (defun zeltak-whatever (&rest rest) (interactive) (save-excursion    
