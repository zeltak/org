...
* `TODO` 							  :CANCELLED:
  ...
  :END:
** capture template for travel
** capture refile to a specifc file.₆In example₆ only ask to refile to headers in a pre defined files
** @org revison@
*** TODO todo
**** TODO gen 
...
** get a handle on tabkes (using hydra) for spreadsheet like stuff
