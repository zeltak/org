...
proc means data=sumPdataa_2001 n min max mean std nmiss;
var d; 
run; 
...
PROC EXPORT DATA= Error_final
            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.5.Results\RMSE\mod1.csv" 
			            DBMS=CSV REPLACE;
						     PUTNAMES=YES;
							 RUN;
