...
PROC IMPORT OUT= WORK.pred_&stp._&year
            DATAFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN002_mod1_CV\mod1_T&year._10_&stp..dbf" 
			            DBMS=DBF   REPLACE;
						     GETDELETED=NO;
							 RUN; 

data pred_&stp._&year;
set pred_&stp._&year ;
newdate = input(date,DATE9.);
format newdate mmddyy10.;
drop date;
if aod ne . then delete;
run;


data pred_&stp._&year;
set pred_&stp._&year(rename=(newdate=date ));;
run;



PROC IMPORT OUT= mod3_&year._&stp
            DATAFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN010_mod3_CV_pred_mpm_val\poll_T&year._&stp..dbf" 
			            DBMS=DBF   REPLACE;
						     GETDELETED=NO;
							 RUN; 
...
proc sort data = pred_&stp._&year; by guid date   ;run;
proc sort data = mod3_&year._&stp ; by guid date ;run;

data m3_merg_&year._&stp;
merge pred_&stp._&year(in=a) mod3_&year._&stp (in=b)  ;
  by guid date;
    if a;
	run; 
...
data all_10p_2000;
 set  m3_merg_2000_s2 m3_merg_2000_s3 m3_merg_2000_s4 m3_merg_2000_s5 m3_merg_2000_s6 m3_merg_2000_s7 m3_merg_2000_s8 m3_merg_2000_s9 m3_merg_2000_s10;
run;



 PROC EXPORT DATA= WORK.all_10p_2000
             OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN006_mod3pred__localPM\m3si_2000_val.csv" 
			             DBMS=CSV REPLACE;
						      PUTNAMES=YES;
							  RUN;
...
run;
 ...
 PROC EXPORT DATA= WORK.all_10p_2001
             OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN006_mod3pred__localPM\m3si_2001_val.csv" 
			             DBMS=CSV REPLACE;
						      PUTNAMES=YES;
							  RUN;
...
run;
 ...
 PROC EXPORT DATA= WORK.all_10p_2002
             OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN006_mod3pred__localPM\m3si_2002_val.csv" 
			             DBMS=CSV REPLACE;
						      PUTNAMES=YES;
							  RUN;
...
run;
 ...
 PROC EXPORT DATA= WORK.all_10p_2003
             OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN006_mod3pred__localPM\m3si_2003_val.csv" 
			             DBMS=CSV REPLACE;
						      PUTNAMES=YES;
							  RUN;
...
run;
 ...
 PROC EXPORT DATA= WORK.all_10p_2004
             OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN006_mod3pred__localPM\m3si_2004_val.csv" 
			             DBMS=CSV REPLACE;
						      PUTNAMES=YES;
							  RUN;
...
run;
 ...
 PROC EXPORT DATA= WORK.all_10p_2005
             OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN006_mod3pred__localPM\m3si_2005_val.csv" 
			             DBMS=CSV REPLACE;
						      PUTNAMES=YES;
							  RUN;
...
run;
 ...
 PROC EXPORT DATA= WORK.all_10p_2006
             OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN006_mod3pred__localPM\m3si_2006_val.csv" 
			             DBMS=CSV REPLACE;
						      PUTNAMES=YES;
							  RUN;
...
run;
 ...
 PROC EXPORT DATA= WORK.all_10p_2007
             OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN006_mod3pred__localPM\m3si_2007_val.csv" 
			             DBMS=CSV REPLACE;
						      PUTNAMES=YES;
							  RUN;
...
run;
 ...
 PROC EXPORT DATA= WORK.all_10p_2008
             OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN006_mod3pred__localPM\m3si_2008_val.csv" 
			             DBMS=CSV REPLACE;
						      PUTNAMES=YES;
							  RUN;
