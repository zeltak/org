...
PROC IMPORT OUT= WORK.mod2pred2000
           DATAFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN004_mod2pred\T2000_m2_pred.dbf" 
		               DBMS=DBF REPLACE;
					        GETDELETED=NO;
							RUN; 
...
merge mod2pred2000(in=a) Mean_2000_v4 (in=b keep=date reg_id mpm_F)  ;
  by date reg_id;
	...
	data mod2pred2000_V3 (keep=guid lat_aod long_aod mpm_F bimon pred date );
	set mod2pred2000_V2;
	m = month(date); 
...
PROC EXPORT DATA= WORK.mod2pred2000_V3
            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN004_mod2pred\T2000_m2_pred_mpm.csv" 
			            DBMS=CSV REPLACE;
						     PUTNAMES=YES;
							 RUN;
...
libname fullg 'c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\2.Gather_data\FN011_mod3_pre_mpm\' ;
...
merge fgrid2000(in=a) Mean_2000_v4 (in=b keep=date reg_id mpm_F)  ;
  by date reg_id;
	...
	data fgrid2000_V3 (keep=guid lat_aod long_aod mpm_F bimon date);
	set fgrid2000_V2;
	m = month(date); 
if (m=1 or m=2) then bimon=1; 
if (m=3 or m=4) then bimon=2;
...
if (m=9 or m=10) then bimon=5;
if (m=11 or m=12) then bimon=6;
if ((date>='01JAN2000'D and date<='29FEB2000'D )) then delete ;
	run; 


	PROC EXPORT DATA= WORK.fgrid2000_V3
	            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN005_mod3\fullgrid_mpm_2000.csv" 
				            DBMS=CSV REPLACE;
							     PUTNAMES=YES;
								 RUN;
...
PROC IMPORT OUT= WORK.mod2pred2001
           DATAFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN004_mod2pred\T2001_m2_pred.dbf" 
		               DBMS=DBF REPLACE;
					        GETDELETED=NO;
							RUN; 
...
merge mod2pred2001(in=a) Mean_2001_v4 (in=b keep=date reg_id mpm_F)  ;
  by date reg_id;
	...
	data mod2pred2001_V3 (keep=guid lat_aod long_aod mpm_F bimon pred date );
	set mod2pred2001_V2;
	m = month(date); 
if (m=1 or m=2) then bimon=1; 
if (m=3 or m=4) then bimon=2;
...
PROC EXPORT DATA= WORK.mod2pred2001_V3
            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN004_mod2pred\T2001_m2_pred_mpm.csv" 
			            DBMS=CSV REPLACE;
						     PUTNAMES=YES;
							 RUN;
...
merge fgrid2001(in=a) Mean_2001_v4 (in=b keep=date reg_id mpm_F)  ;
  by date reg_id;
	...
	data fgrid2001_V3 (keep=guid lat_aod long_aod mpm_F bimon date);
	set fgrid2001_V2;
	m = month(date); 
if (m=1 or m=2) then bimon=1; 
if (m=3 or m=4) then bimon=2;
...
if (m=11 or m=12) then bimon=6;
	...
	PROC EXPORT DATA= WORK.fgrid2001_V3
	            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN005_mod3\fullgrid_mpm_2001.csv" 
				            DBMS=CSV REPLACE;
							     PUTNAMES=YES;
								 RUN;
...
PROC IMPORT OUT= WORK.mod2pred2002
           DATAFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN004_mod2pred\T2002_m2_pred.dbf" 
		               DBMS=DBF REPLACE;
					        GETDELETED=NO;
							RUN; 
...
merge mod2pred2002(in=a) Mean_2002_v4 (in=b keep=date reg_id mpm_F)  ;
  by date reg_id;
	...
	data mod2pred2002_V3 (keep=guid lat_aod long_aod mpm_F bimon pred date );
	set mod2pred2002_V2;
	m = month(date); 
if (m=1 or m=2) then bimon=1; 
if (m=3 or m=4) then bimon=2;
...
PROC EXPORT DATA= WORK.mod2pred2002_V3
            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN004_mod2pred\T2002_m2_pred_mpm.csv" 
			            DBMS=CSV REPLACE;
						     PUTNAMES=YES;
							 RUN;
...
merge fgrid2002(in=a) Mean_2002_v4 (in=b keep=date reg_id mpm_F)  ;
  by date reg_id;
	...
	data fgrid2002_V3 (keep=guid lat_aod long_aod mpm_F bimon date);
	set fgrid2002_V2;
	m = month(date); 
if (m=1 or m=2) then bimon=1; 
if (m=3 or m=4) then bimon=2;
...
if (m=11 or m=12) then bimon=6;
	...
	PROC EXPORT DATA= WORK.fgrid2002_V3
	            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN005_mod3\fullgrid_mpm_2002.csv" 
				            DBMS=CSV REPLACE;
							     PUTNAMES=YES;
								 RUN;
...
PROC IMPORT OUT= WORK.mod2pred2003
           DATAFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN004_mod2pred\T2003_m2_pred.dbf" 
		               DBMS=DBF REPLACE;
					        GETDELETED=NO;
							RUN; 
...
merge mod2pred2003(in=a) Mean_2003_v4 (in=b keep=date reg_id mpm_F)  ;
  by date reg_id;
	...
	data mod2pred2003_V3 (keep=guid lat_aod long_aod mpm_F bimon pred date );
	set mod2pred2003_V2;
	m = month(date); 
if (m=1 or m=2) then bimon=1; 
if (m=3 or m=4) then bimon=2;
...
PROC EXPORT DATA= WORK.mod2pred2003_V3
            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN004_mod2pred\T2003_m2_pred_mpm.csv" 
			            DBMS=CSV REPLACE;
						     PUTNAMES=YES;
							 RUN;
...
merge fgrid2003(in=a) Mean_2003_v4 (in=b keep=date reg_id mpm_F)  ;
  by date reg_id;
	...
	data fgrid2003_V3 (keep=guid lat_aod long_aod mpm_F bimon date);
	set fgrid2003_V2;
	m = month(date); 
if (m=1 or m=2) then bimon=1; 
if (m=3 or m=4) then bimon=2;
...
if (m=11 or m=12) then bimon=6;
	...
	PROC EXPORT DATA= WORK.fgrid2003_V3
	            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN005_mod3\fullgrid_mpm_2003.csv" 
				            DBMS=CSV REPLACE;
							     PUTNAMES=YES;
								 RUN;
...
PROC IMPORT OUT= WORK.mod2pred2004
           DATAFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN004_mod2pred\T2004_m2_pred.dbf" 
		               DBMS=DBF REPLACE;
					        GETDELETED=NO;
							RUN; 
...
merge mod2pred2004(in=a) Mean_2004_v4 (in=b keep=date reg_id mpm_F)  ;
  by date reg_id;
	...
	data mod2pred2004_V3 (keep=guid lat_aod long_aod mpm_F bimon pred date );
	set mod2pred2004_V2;
	m = month(date); 
if (m=1 or m=2) then bimon=1; 
if (m=3 or m=4) then bimon=2;
...
PROC EXPORT DATA= WORK.mod2pred2004_V3
            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN004_mod2pred\T2004_m2_pred_mpm.csv" 
			            DBMS=CSV REPLACE;
						     PUTNAMES=YES;
							 RUN;
...
merge fgrid2004(in=a) Mean_2004_v4 (in=b keep=date reg_id mpm_F)  ;
  by date reg_id;
	...
	data fgrid2004_V3 (keep=guid lat_aod long_aod mpm_F bimon date);
	set fgrid2004_V2;
	m = month(date); 
if (m=1 or m=2) then bimon=1; 
if (m=3 or m=4) then bimon=2;
...
if (m=11 or m=12) then bimon=6;
	...
	PROC EXPORT DATA= WORK.fgrid2004_V3
	            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN005_mod3\fullgrid_mpm_2004.csv" 
				            DBMS=CSV REPLACE;
							     PUTNAMES=YES;
								 RUN;
...
PROC IMPORT OUT= WORK.mod2pred2005
           DATAFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN004_mod2pred\T2005_m2_pred.dbf" 
		               DBMS=DBF REPLACE;
					        GETDELETED=NO;
							RUN; 
...
merge mod2pred2005(in=a) Mean_2005_v4 (in=b keep=date reg_id mpm_F)  ;
  by date reg_id;
	...
	data mod2pred2005_V3 (keep=guid lat_aod long_aod mpm_F bimon pred date );
	set mod2pred2005_V2;
	m = month(date); 
if (m=1 or m=2) then bimon=1; 
if (m=3 or m=4) then bimon=2;
...
PROC EXPORT DATA= WORK.mod2pred2005_V3
            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN004_mod2pred\T2005_m2_pred_mpm.csv" 
			            DBMS=CSV REPLACE;
						     PUTNAMES=YES;
							 RUN;
...
merge fgrid2005(in=a) Mean_2005_v4 (in=b keep=date reg_id mpm_F)  ;
  by date reg_id;
	...
	data fgrid2005_V3 (keep=guid lat_aod long_aod mpm_F bimon date);
	set fgrid2005_V2;
	m = month(date); 
if (m=1 or m=2) then bimon=1; 
if (m=3 or m=4) then bimon=2;
...
if (m=11 or m=12) then bimon=6;
	...
	PROC EXPORT DATA= WORK.fgrid2005_V3
	            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN005_mod3\fullgrid_mpm_2005.csv" 
				            DBMS=CSV REPLACE;
							     PUTNAMES=YES;
								 RUN;
...
PROC IMPORT OUT= WORK.mod2pred2006
           DATAFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN004_mod2pred\T2006_m2_pred.dbf" 
		               DBMS=DBF REPLACE;
					        GETDELETED=NO;
							RUN; 
...
merge mod2pred2006(in=a) Mean_2006_v4 (in=b keep=date reg_id mpm_F)  ;
  by date reg_id;
	...
	data mod2pred2006_V3 (keep=guid lat_aod long_aod mpm_F bimon pred date );
	set mod2pred2006_V2;
	m = month(date); 
if (m=1 or m=2) then bimon=1; 
if (m=3 or m=4) then bimon=2;
...
PROC EXPORT DATA= WORK.mod2pred2006_V3
            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN004_mod2pred\T2006_m2_pred_mpm.csv" 
			            DBMS=CSV REPLACE;
						     PUTNAMES=YES;
							 RUN;
...
merge fgrid2006(in=a) Mean_2006_v4 (in=b keep=date reg_id mpm_F)  ;
  by date reg_id;
	...
	data fgrid2006_V3 (keep=guid lat_aod long_aod mpm_F bimon date);
	set fgrid2006_V2;
	m = month(date); 
if (m=1 or m=2) then bimon=1; 
if (m=3 or m=4) then bimon=2;
...
if (m=11 or m=12) then bimon=6;
	...
	PROC EXPORT DATA= WORK.fgrid2006_V3
	            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN005_mod3\fullgrid_mpm_2006.csv" 
				            DBMS=CSV REPLACE;
							     PUTNAMES=YES;
								 RUN;
...
PROC IMPORT OUT= WORK.mod2pred2007
           DATAFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN004_mod2pred\T2007_m2_pred.dbf" 
		               DBMS=DBF REPLACE;
					        GETDELETED=NO;
							RUN; 
...
merge mod2pred2007(in=a) Mean_2007_v4 (in=b keep=date reg_id mpm_F)  ;
  by date reg_id;
	...
	data mod2pred2007_V3 (keep=guid lat_aod long_aod mpm_F bimon pred date );
	set mod2pred2007_V2;
	m = month(date); 
if (m=1 or m=2) then bimon=1; 
if (m=3 or m=4) then bimon=2;
...
PROC EXPORT DATA= WORK.mod2pred2007_V3
            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN004_mod2pred\T2007_m2_pred_mpm.csv" 
			            DBMS=CSV REPLACE;
						     PUTNAMES=YES;
							 RUN;
...
merge fgrid2007(in=a) Mean_2007_v4 (in=b keep=date reg_id mpm_F)  ;
  by date reg_id;
	...
	data fgrid2007_V3 (keep=guid lat_aod long_aod mpm_F bimon date);
	set fgrid2007_V2;
	m = month(date); 
if (m=1 or m=2) then bimon=1; 
if (m=3 or m=4) then bimon=2;
...
if (m=11 or m=12) then bimon=6;
	...
	PROC EXPORT DATA= WORK.fgrid2007_V3
	            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN005_mod3\fullgrid_mpm_2007.csv" 
				            DBMS=CSV REPLACE;
							     PUTNAMES=YES;
								 RUN;
...
PROC IMPORT OUT= WORK.mod2pred2008
           DATAFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN004_mod2pred\T2008_m2_pred.dbf" 
		               DBMS=DBF REPLACE;
					        GETDELETED=NO;
							RUN; 
...
merge mod2pred2008(in=a) Mean_2008_v4 (in=b keep=date reg_id mpm_F)  ;
  by date reg_id;
	...
	data mod2pred2008_V3 (keep=guid lat_aod long_aod mpm_F bimon pred date );
	set mod2pred2008_V2;
	m = month(date); 
if (m=1 or m=2) then bimon=1; 
if (m=3 or m=4) then bimon=2;
...
PROC EXPORT DATA= WORK.mod2pred2008_V3
            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN004_mod2pred\T2008_m2_pred_mpm.csv" 
			            DBMS=CSV REPLACE;
						     PUTNAMES=YES;
							 RUN;
...
merge fgrid2008(in=a) Mean_2008_v4 (in=b keep=date reg_id mpm_F)  ;
  by date reg_id;
	...
	data fgrid2008_V3 (keep=guid lat_aod long_aod mpm_F bimon date);
	set fgrid2008_V2;
	m = month(date); 
if (m=1 or m=2) then bimon=1; 
if (m=3 or m=4) then bimon=2;
...
if (m=11 or m=12) then bimon=6;
	...
	PROC EXPORT DATA= WORK.fgrid2008_V3
	            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN005_mod3\fullgrid_mpm_2008.csv" 
				            DBMS=CSV REPLACE;
							     PUTNAMES=YES;
								 RUN;
