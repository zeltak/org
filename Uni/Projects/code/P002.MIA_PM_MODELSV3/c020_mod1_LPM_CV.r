...
# IMPORTS
F_T2000_All <-read.csv("c:/Users/ekloog/Documents/$Doc/3.PostDoc/3.1.Projetcs/3.1.2.MIA_PM_MODELSV3/3.1.1.4.Work/3.Analysis/AN002_mod1_CV/sas export/t2000_all_10p.csv",header=T) 
names(F_T2000_All)



#calculate R2 pre local pm and spatial vs temporal
mod_all <- lm(PM25 ~ pred, data=F_T2000_All)
summary(mod_all)
...
# IMPORTS
F_T2001_All <-read.csv("c:/Users/ekloog/Documents/$Doc/3.PostDoc/3.1.Projetcs/3.1.2.MIA_PM_MODELSV3/3.1.1.4.Work/3.Analysis/AN002_mod1_CV/sas export/t2001_all_10p.csv",header=T) 
names(F_T2001_All)



#calculate R2 pre local pm and spatial vs temporal
mod_all <- lm(PM25 ~ pred, data=F_T2001_All)
summary(mod_all)
...
# IMPORTS
F_T2002_All <-read.csv("c:/Users/ekloog/Documents/$Doc/3.PostDoc/3.1.Projetcs/3.1.2.MIA_PM_MODELSV3/3.1.1.4.Work/3.Analysis/AN002_mod1_CV/sas export/t2002_all_10p.csv",header=T) 
names(F_T2002_All)



#calculate R2 pre local pm and spatial vs temporal
mod_all <- lm(PM25 ~ pred, data=F_T2002_All)
summary(mod_all)
...
# IMPORTS
F_T2003_All <-read.csv("c:/Users/ekloog/Documents/$Doc/3.PostDoc/3.1.Projetcs/3.1.2.MIA_PM_MODELSV3/3.1.1.4.Work/3.Analysis/AN002_mod1_CV/sas export/t2003_all_10p.csv",header=T) 
names(F_T2003_All)



#calculate R2 pre local pm and spatial vs temporal
mod_all <- lm(PM25 ~ pred, data=F_T2003_All)
summary(mod_all)
...
# IMPORTS
F_T2004_All <-read.csv("c:/Users/ekloog/Documents/$Doc/3.PostDoc/3.1.Projetcs/3.1.2.MIA_PM_MODELSV3/3.1.1.4.Work/3.Analysis/AN002_mod1_CV/sas export/t2004_all_10p.csv",header=T) 
names(F_T2004_All)



#calculate R2 pre local pm and spatial vs temporal
mod_all <- lm(PM25 ~ pred, data=F_T2004_All)
summary(mod_all)
...
# IMPORTS
F_T2005_All <-read.csv("c:/Users/ekloog/Documents/$Doc/3.PostDoc/3.1.Projetcs/3.1.2.MIA_PM_MODELSV3/3.1.1.4.Work/3.Analysis/AN002_mod1_CV/sas export/t2005_all_10p.csv",header=T) 
names(F_T2005_All)



#calculate R2 pre local pm and spatial vs temporal
mod_all <- lm(PM25 ~ pred, data=F_T2005_All)
summary(mod_all)
...
# IMPORTS
F_T2006_All <-read.csv("c:/Users/ekloog/Documents/$Doc/3.PostDoc/3.1.Projetcs/3.1.2.MIA_PM_MODELSV3/3.1.1.4.Work/3.Analysis/AN002_mod1_CV/sas export/t2006_all_10p.csv",header=T) 
names(F_T2006_All)



#calculate R2 pre local pm and spatial vs temporal
mod_all <- lm(PM25 ~ pred, data=F_T2006_All)
summary(mod_all)
...
# IMPORTS
F_T2007_All <-read.csv("c:/Users/ekloog/Documents/$Doc/3.PostDoc/3.1.Projetcs/3.1.2.MIA_PM_MODELSV3/3.1.1.4.Work/3.Analysis/AN002_mod1_CV/sas export/t2007_all_10p.csv",header=T) 
names(F_T2007_All)



#calculate R2 pre local pm and spatial vs temporal
mod_all <- lm(PM25 ~ pred, data=F_T2007_All)
summary(mod_all)
...
# IMPORTS
F_T2008_All <-read.csv("c:/Users/ekloog/Documents/$Doc/3.PostDoc/3.1.Projetcs/3.1.2.MIA_PM_MODELSV3/3.1.1.4.Work/3.Analysis/AN002_mod1_CV/sas export/t2008_all_10p.csv",header=T) 
names(F_T2008_All)



#calculate R2 pre local pm and spatial vs temporal
mod_all <- lm(PM25 ~ pred, data=F_T2008_All)
summary(mod_all)
...
#export for RMSE
write.csv(T2000_merged,"c:/Users/ekloog/Documents/$Doc/3.PostDoc/3.1.Projetcs/3.1.2.MIA_PM_MODELSV3/3.1.1.4.Work/3.Analysis/AN080_files_4CV_RMSE/t2000.csv") 

write.csv(T2001_merged,"c:/Users/ekloog/Documents/$Doc/3.PostDoc/3.1.Projetcs/3.1.2.MIA_PM_MODELSV3/3.1.1.4.Work/3.Analysis/AN080_files_4CV_RMSE/t2001.csv") 

write.csv(T2002_merged,"c:/Users/ekloog/Documents/$Doc/3.PostDoc/3.1.Projetcs/3.1.2.MIA_PM_MODELSV3/3.1.1.4.Work/3.Analysis/AN080_files_4CV_RMSE/t2002.csv") 

write.csv(T2003_merged,"c:/Users/ekloog/Documents/$Doc/3.PostDoc/3.1.Projetcs/3.1.2.MIA_PM_MODELSV3/3.1.1.4.Work/3.Analysis/AN080_files_4CV_RMSE/t2003.csv") 

write.csv(T2004_merged,"c:/Users/ekloog/Documents/$Doc/3.PostDoc/3.1.Projetcs/3.1.2.MIA_PM_MODELSV3/3.1.1.4.Work/3.Analysis/AN080_files_4CV_RMSE/t2004.csv") 

write.csv(T2005_merged,"c:/Users/ekloog/Documents/$Doc/3.PostDoc/3.1.Projetcs/3.1.2.MIA_PM_MODELSV3/3.1.1.4.Work/3.Analysis/AN080_files_4CV_RMSE/t2005.csv") 

write.csv(T2006_merged,"c:/Users/ekloog/Documents/$Doc/3.PostDoc/3.1.Projetcs/3.1.2.MIA_PM_MODELSV3/3.1.1.4.Work/3.Analysis/AN080_files_4CV_RMSE/t2006.csv") 

write.csv(T2007_merged,"c:/Users/ekloog/Documents/$Doc/3.PostDoc/3.1.Projetcs/3.1.2.MIA_PM_MODELSV3/3.1.1.4.Work/3.Analysis/AN080_files_4CV_RMSE/t2007.csv") 

write.csv(T2008_merged,"c:/Users/ekloog/Documents/$Doc/3.PostDoc/3.1.Projetcs/3.1.2.MIA_PM_MODELSV3/3.1.1.4.Work/3.Analysis/AN080_files_4CV_RMSE/t2008.csv") 
...
write.csv(cvtable,"c:/Users/ekloog/Documents/$Doc/3.PostDoc/3.1.Projetcs/3.1.2.MIA_PM_MODELSV3/3.1.1.5.Results/mod1cv/Final_mod1CV_table.csv") 
