...
PROC EXPORT DATA= WORK.cVTable2001 
            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.5.Results\mod1cv\sas_cv_2001.xls" 
            DBMS=EXCEL5 REPLACE;
RUN;
...
PROC EXPORT DATA= ran_all_2001 
            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.2.MIA_PM_MODELSV3\3.1.1.4.Work\3.Analysis\AN002_mod1_CV\sas export\t2001_all_10p.csv" 
			            DBMS=CSV REPLACE;
						     PUTNAMES=YES;
							 RUN;
