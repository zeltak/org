...
proc sort data = Zipguid; by zipcode   ;run;
proc sort data = cases_count ; by zipcode ;run;
...
PROC EXPORT DATA= WORK.times7
            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.10.Medicare_NE\3.1.10.4.Work\3.Analysis\AN001_R_files_bycase\short\m23\&type.0106.csv" 
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN;
...
PROC EXPORT DATA= WORK.times7
            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.10.Medicare_NE\3.1.10.4.Work\3.Analysis\AN001_R_files_bycase\short\m23\resp0106.csv" 
			            DBMS=CSV REPLACE;
						     PUTNAMES=YES;
							 RUN;
