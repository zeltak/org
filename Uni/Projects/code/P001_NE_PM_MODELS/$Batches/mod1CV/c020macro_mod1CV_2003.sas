...
PROC IMPORT OUT= WORK.mod1_T2003_90_&Stp
            DATAFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.4.Work\3.Analysis\AN002_mod1_CV\mod1_T2003_90_&stp..dbf" 
            DBMS=DBF REPLACE;
     GETDELETED=NO;
RUN;
...
PROC IMPORT OUT= WORK.mod1_T2003_10_&Stp
            DATAFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.4.Work\3.Analysis\AN002_mod1_CV\mod1_T2003_10_&stp..dbf" 
            DBMS=DBF REPLACE;
     GETDELETED=NO;
RUN;
...
PROC EXPORT DATA= WORK.cVTable2003 
            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.5.Results\mod1cv\sas_cv_2003.xls" 
            DBMS=EXCEL5 REPLACE;
RUN;
...
PROC EXPORT DATA= ran_all_2003 
            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.4.Work\3.Analysis\AN002_mod1_CV\sas export\t2003_all_10p.csv" 
			            DBMS=CSV REPLACE;
						     PUTNAMES=YES;
							 RUN;
