libname out10 'c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.4.Work\3.Analysis\AN002_mod1_CV\overall_random\' ;
...
PROC IMPORT OUT= mod3_&year._&stp
            DATAFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.4.Work\3.Analysis\AN010_mod3_CV_pred_mpm\poll_T&year._&stp..dbf" 
			            DBMS=DBF   REPLACE;
						     GETDELETED=NO;
							 RUN; 
...
run;
 ...
 PROC EXPORT DATA= WORK.all_10p_2000
             OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.4.Work\3.Analysis\AN006_mod3_localPM\m3si_2000.csv" 
			             DBMS=CSV REPLACE;
						      PUTNAMES=YES;
							  RUN;
...
run;
 ...
 PROC EXPORT DATA= WORK.all_10p_2001
             OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.4.Work\3.Analysis\AN006_mod3_localPM\m3si_2001.csv" 
			             DBMS=CSV REPLACE;
						      PUTNAMES=YES;
							  RUN;
...
run;
 ...
 PROC EXPORT DATA= WORK.all_10p_2002
             OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.4.Work\3.Analysis\AN006_mod3_localPM\m3si_2002.csv" 
			             DBMS=CSV REPLACE;
						      PUTNAMES=YES;
							  RUN;
...
run;
 ...
 PROC EXPORT DATA= WORK.all_10p_2003
             OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.4.Work\3.Analysis\AN006_mod3_localPM\m3si_2003.csv" 
			             DBMS=CSV REPLACE;
						      PUTNAMES=YES;
							  RUN;
...
run;
 ...
 PROC EXPORT DATA= WORK.all_10p_2004
             OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.4.Work\3.Analysis\AN006_mod3_localPM\m3si_2004.csv" 
			             DBMS=CSV REPLACE;
						      PUTNAMES=YES;
							  RUN;
...
run;
 ...
 PROC EXPORT DATA= WORK.all_10p_2005
             OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.4.Work\3.Analysis\AN006_mod3_localPM\m3si_2005.csv" 
			             DBMS=CSV REPLACE;
						      PUTNAMES=YES;
							  RUN;
...
run;
 ...
 PROC EXPORT DATA= WORK.all_10p_2006
             OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.4.Work\3.Analysis\AN006_mod3_localPM\m3si_2006.csv" 
			             DBMS=CSV REPLACE;
						      PUTNAMES=YES;
							  RUN;
...
run;
 ...
 PROC EXPORT DATA= WORK.all_10p_2007
             OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.4.Work\3.Analysis\AN006_mod3_localPM\m3si_2007.csv" 
			             DBMS=CSV REPLACE;
						      PUTNAMES=YES;
							  RUN;
...
run;
 ...
 PROC EXPORT DATA= WORK.all_10p_2008
             OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.4.Work\3.Analysis\AN006_mod3_localPM\m3si_2008.csv" 
			             DBMS=CSV REPLACE;
						      PUTNAMES=YES;
							  RUN;
...
PROC EXPORT DATA= WORK.overallCV
            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.5.Results\mod3cv\mod3CV.xls" 
			            DBMS=EXCEL5 REPLACE;
						RUN; 
...
PROC EXPORT DATA= WORK.table_CV
            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.5.Results\mod3cv\mod3_ST_CV.xls" 
			            DBMS=EXCEL5 REPLACE;
						RUN; 
