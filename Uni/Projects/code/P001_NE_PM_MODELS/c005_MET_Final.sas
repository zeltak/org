...
proc sort data = all_MET; by c   ;run; 

ods trace on;
proc freq data=all_MET;
table stn / list;
 by c;
...
data OneWayFreqs&year(keep = stn stn_&year Freq&year);
 set OneWayFreqs;
  where c = "&year";
   stn_&year = stn;
   Freq&year = Frequency;
...
proc sort data = OneWayFreqs&year; by stn;run; 
...
data Station;
 merge OneWayFreqs2000 OneWayFreqs2001 OneWayFreqs2002 OneWayFreqs2003 
       OneWayFreqs2004 OneWayFreqs2005 OneWayFreqs2006 OneWayFreqs2007 
       OneWayFreqs2008 OneWayFreqs2009;
 by stn;
run;
...
/**/
/*proc summary nway data=metallxy;*/
/*class stn;*/
/*var long_met lat_met;*/
/*output out=metagg_all mean=long_met lat_met;*/
/*run;*/
/**/
/*PROC EXPORT DATA= WORK.metagg2000 */
/*            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.4.Work\2.Gather_data\FN007_Key_tables\metagg2000.dbf" */
/*			            DBMS=DBF REPLACE;*/
/*						RUN;*/
...
PROC EXPORT DATA= WORK.metagg2001 
            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.4.Work\2.Gather_data\FN007_Key_tables\metagg2001.dbf" 
			            DBMS=DBF REPLACE;
						RUN;
...
PROC EXPORT DATA= WORK.metagg2002 
            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.4.Work\2.Gather_data\FN007_Key_tables\metagg2002.dbf" 
			            DBMS=DBF REPLACE;
						RUN;
...
PROC EXPORT DATA= WORK.metagg2003 
            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.4.Work\2.Gather_data\FN007_Key_tables\metagg2003.dbf" 
			            DBMS=DBF REPLACE;
						RUN;
...
PROC EXPORT DATA= WORK.metagg2004 
            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.4.Work\2.Gather_data\FN007_Key_tables\metagg2004.dbf" 
			            DBMS=DBF REPLACE;
						RUN;
...
PROC EXPORT DATA= WORK.metagg2005 
            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.4.Work\2.Gather_data\FN007_Key_tables\metagg2005.dbf" 
			            DBMS=DBF REPLACE;
						RUN;
...
PROC EXPORT DATA= WORK.metagg2006 
            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.4.Work\2.Gather_data\FN007_Key_tables\metagg2006.dbf" 
			            DBMS=DBF REPLACE;
						RUN;
...
PROC EXPORT DATA= WORK.metagg2007 
            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.4.Work\2.Gather_data\FN007_Key_tables\metagg2007.dbf" 
			            DBMS=DBF REPLACE;
						RUN;
...
PROC EXPORT DATA= WORK.metagg2008 
            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.4.Work\2.Gather_data\FN007_Key_tables\metagg2008.dbf" 
			            DBMS=DBF REPLACE;
						RUN;
...
/*PART 5: EXPORT YEARLT MET FILES>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> */ 
	...
	libname met2 'c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.4.Work\2.Gather_data\FN005_MET_full_dataset\' ;
