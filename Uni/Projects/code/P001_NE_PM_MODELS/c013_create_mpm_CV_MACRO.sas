...
PROC IMPORT OUT= WORK.mod2pred&year._&it
           DATAFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.4.Work\3.Analysis\AN009_mod2_CV_files\T&year._m2_pred_&it..dbf" 
		               DBMS=DBF REPLACE;
					        GETDELETED=NO;
							RUN; 
...
PROC EXPORT DATA= WORK.mod2pred&year._V3
            OUTFILE= "c:\Users\ekloog\Documents\$Doc\3.PostDoc\3.1.Projetcs\3.1.1.NE_PM_MODELS\3.1.1.4.Work\3.Analysis\AN009_mod2_CV_files_mpm\T&year._m2_pred_mpm_&it..csv" 
			            DBMS=CSV REPLACE;
						     PUTNAMES=YES;
							 RUN;
