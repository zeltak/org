...
summary(mod1)
#day dataset
DELLIST <-  names(mod1) %in% c("NTckin", "humidity")
mod1d <- mod1[!DELLIST]
mod1d<-na.omit(mod1d)
mod1d$predicted<-NA
...
out_90_s1 = lme( tempc ~ DTckin+elev+purban+NDVI+ws, random = ~1 + DTckin| date,  data =  mod1d_90_s1) 
...
out_90_s2 = lme( tempc ~ DTckin+elev+purban+NDVI+ws, random = ~1 + DTckin| date,  data =  mod1d_90_s2) 
...
out_90_s3 = lme( tempc ~ DTckin+elev+purban+NDVI+ws, random = ~1 + DTckin| date,  data =  mod1d_90_s3) 
...
out_90_s4 = lme( tempc ~ DTckin+elev+purban+NDVI+ws, random = ~1 + DTckin| date,  data =  mod1d_90_s4) 
...
out_90_s5 = lme( tempc ~ DTckin+elev+purban+NDVI+ws, random = ~1 + DTckin| date,  data =  mod1d_90_s5) 
...
out_90_s6 = lme( tempc ~ DTckin+elev+purban+NDVI+ws, random = ~1 + DTckin| date,  data =  mod1d_90_s6) 
...
out_90_s7 = lme( tempc ~ DTckin+elev+purban+NDVI+ws, random = ~1 + DTckin| date,  data =  mod1d_90_s7) 
...
out_90_s8 = lme( tempc ~ DTckin+elev+purban+NDVI+ws, random = ~1 + DTckin| date,  data =  mod1d_90_s8) 
...
out_90_s9 = lme( tempc ~ DTckin+elev+purban+NDVI+ws, random = ~1 + DTckin| date,  data =  mod1d_90_s9) 
...
out_90_s10 = lme( tempc ~ DTckin+elev+purban+NDVI+ws, random = ~1 + DTckin| date,  data =  mod1d_90_s10) 
...
write.csv(mod1table, "f:/Uni/Projects/P020_Temprature_NE_MIA/4.Results/mod1/DST.csv") 
