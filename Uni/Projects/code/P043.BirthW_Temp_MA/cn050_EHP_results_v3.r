...
## calcute SGA
sgamodel <- gee(birthw ~ges_calc+gender+as.factor(mrn.n),data =  bd)
...
#### bw270
#### bw270
bw270.mod <- gee(birthw ~ ta270+pm270+sinetime+costime+age_centered+age_centered_sq+cig_pre+mgrossrent+p_ospace+cig_pre+gender+prev_400+ diab+hyper+lungd+diab_other+prevpret+as.factor(kess)+as.factor(mrn.n)+as.factor(edu_group)+as.factor(byob)+parity+as.factor(FRN)+ges_calc+elev,family=gaussian, id=FIPS,data =  bd)
bw270.res<-bw270.mod
...
confint.gee <- function(object, parm, level = 0.95, ...) {
  ...
  citab <- with(as.data.frame(cc),
                cbind(lwr=Estimate-1.96*"Naive S.E.",
                      upr=Estimate+1.96*"Naive S.E."))
  rownames(citab) <- rownames(cc)
  citab[parm,]
}

confint.gee(bw270.mod)


paper_table$bw270[1] <- coef(summary(bw270.res))[2,1]  #extract Betas
paper_table$bw270[2] <-coef(summary(bw270.res))[2,2] #extract SE
...
paper_table$bw270[5] <-coef(summary(bw270.res))[2,3] #tstat
paper_table$bw270[6] <-coef(summary(bw270.res))[2,4] #sig
#pm
paper_table$pm270[1] <- coef(summary(bw270.res))[3,1]  #extract Betas
paper_table$pm270[2] <-coef(summary(bw270.res))[3,2] #extract SE
...
paper_table$pm270[5] <-coef(summary(bw270.res))[3,3] #tstat
paper_table$pm270[6] <-coef(summary(bw270.res))[3,4] #sig


#### bw90
bw90.mod <- gee(birthw ~ ta90+pm90+sinetime+costime+age_centered+age_centered_sq+cig_pre+mgrossrent+p_ospace+cig_pre+gender+prev_400+ diab+hyper+lungd+diab_other+prevpret+as.factor(kess)+as.factor(mrn.n)+as.factor(edu_group)+as.factor(byob)+parity+as.factor(FRN)+ges_calc+elev,family=gaussian, id=FIPS,data =  bd)
bw90.res<-bw90.mod
...
#### bw30
bw30.mod <- gee(birthw ~ ta30+pm30+sinetime+costime+age_centered+age_centered_sq+cig_pre+mgrossrent+p_ospace+cig_pre+gender+prev_400+ diab+hyper+lungd+diab_other+prevpret+as.factor(kess)+as.factor(mrn.n)+as.factor(edu_group)+as.factor(byob)+parity+as.factor(FRN)+ges_calc+elev,family=gaussian, id=FIPS,data =  bd)
bw30.res<-bw30.mod
...
#### bw14
bw14.mod <- gee(birthw ~ ta14+pm14+sinetime+costime+age_centered+age_centered_sq+cig_pre+mgrossrent+p_ospace+cig_pre+gender+prev_400+ diab+hyper+lungd+diab_other+prevpret+as.factor(kess)+as.factor(mrn.n)+as.factor(edu_group)+as.factor(byob)+parity+as.factor(FRN)+ges_calc+elev,family=gaussian, id=FIPS,data =  bd)
bw14.res<-bw14.mod
...
#### bw7
bw7.mod <- gee(birthw ~ ta7+pm7+sinetime+costime+age_centered+age_centered_sq+cig_pre+mgrossrent+p_ospace+cig_pre+gender+prev_400+ diab+hyper+lungd+diab_other+prevpret+as.factor(kess)+as.factor(mrn.n)+as.factor(edu_group)+as.factor(byob)+parity+as.factor(FRN)+ges_calc+elev,family=gaussian, id=FIPS,data =  bd)
bw7.res<-bw7.mod
...
#### bw3
bw3.mod <- gee(birthw ~ ta3+pm3+sinetime+costime+age_centered+age_centered_sq+cig_pre+mgrossrent+p_ospace+cig_pre+gender+prev_400+ diab+hyper+lungd+diab_other+prevpret+as.factor(kess)+as.factor(mrn.n)+as.factor(edu_group)+as.factor(byob)+parity+as.factor(FRN)+ges_calc+elev,family=gaussian, id=FIPS,data =  bd)
bw3.res<-bw3.mod
...
#### bw1
bw1.mod <- gee(birthw ~ ta1+pm1+sinetime+costime+age_centered+age_centered_sq+cig_pre+mgrossrent+p_ospace+cig_pre+gender+prev_400+ diab+hyper+lungd+diab_other+prevpret+as.factor(kess)+as.factor(mrn.n)+as.factor(edu_group)+as.factor(byob)+parity+as.factor(FRN)+ges_calc+elev,family=gaussian, id=FIPS,data =  bd)
bw1.res<-bw1.mod
...
saveRDS(paper_table,"/media/NAS/Uni/Projects/P043_BirthW_Temp_MA/3.1.11.4.Work/3.Analysis/2.R_analysis/bwrestable_gee.rds")
...
#### bw270
#### bw270
bw270.mod <- gee(birthw ~ ncdc270+pm270+sinetime+costime+age_centered+age_centered_sq+cig_pre+mgrossrent+p_ospace+cig_pre+gender+prev_400+ diab+hyper+lungd+diab_other+prevpret+as.factor(kess)+as.factor(mrn.n)+as.factor(edu_group)+as.factor(byob)+parity+as.factor(FRN)+ges_calc+elev,family=gaussian, id=FIPS,data =  bd)
bw270.res<-bw270.mod
#add to table
...
#### bw90
bw90.mod <- gee(birthw ~ ncdc90+pm90+sinetime+costime+age_centered+age_centered_sq+cig_pre+mgrossrent+p_ospace+cig_pre+gender+prev_400+ diab+hyper+lungd+diab_other+prevpret+as.factor(kess)+as.factor(mrn.n)+as.factor(edu_group)+as.factor(byob)+parity+as.factor(FRN)+ges_calc+elev,family=gaussian, id=FIPS,data =  bd)
bw90.res<-bw90.mod
...
#### bw30
bw30.mod <- gee(birthw ~ ncdc30+pm30+sinetime+costime+age_centered+age_centered_sq+cig_pre+mgrossrent+p_ospace+cig_pre+gender+prev_400+ diab+hyper+lungd+diab_other+prevpret+as.factor(kess)+as.factor(mrn.n)+as.factor(edu_group)+as.factor(byob)+parity+as.factor(FRN)+ges_calc+elev,family=gaussian, id=FIPS,data =  bd)
bw30.res<-bw30.mod
...
#### bw14
bw14.mod <- gee(birthw ~ ncdc14+pm14+sinetime+costime+age_centered+age_centered_sq+cig_pre+mgrossrent+p_ospace+cig_pre+gender+prev_400+ diab+hyper+lungd+diab_other+prevpret+as.factor(kess)+as.factor(mrn.n)+as.factor(edu_group)+as.factor(byob)+parity+as.factor(FRN)+ges_calc+elev,family=gaussian, id=FIPS,data =  bd)
bw14.res<-bw14.mod
...
#### bw7
bw7.mod <- gee(birthw ~ ncdc7+pm7+sinetime+costime+age_centered+age_centered_sq+cig_pre+mgrossrent+p_ospace+cig_pre+gender+prev_400+ diab+hyper+lungd+diab_other+prevpret+as.factor(kess)+as.factor(mrn.n)+as.factor(edu_group)+as.factor(byob)+parity+as.factor(FRN)+ges_calc+elev,family=gaussian, id=FIPS,data =  bd)
bw7.res<-bw7.mod
...
#### bw3
bw3.mod <- gee(birthw ~ ncdc3+pm3+sinetime+costime+age_centered+age_centered_sq+cig_pre+mgrossrent+p_ospace+cig_pre+gender+prev_400+ diab+hyper+lungd+diab_other+prevpret+as.factor(kess)+as.factor(mrn.n)+as.factor(edu_group)+as.factor(byob)+parity+as.factor(FRN)+ges_calc+elev,family=gaussian, id=FIPS,data =  bd)
bw3.res<-bw3.mod
...
#### bw1
bw1.mod <- gee(birthw ~ ncdc1+pm1+sinetime+costime+age_centered+age_centered_sq+cig_pre+mgrossrent+p_ospace+cig_pre+gender+prev_400+ diab+hyper+lungd+diab_other+prevpret+as.factor(kess)+as.factor(mrn.n)+as.factor(edu_group)+as.factor(byob)+parity+as.factor(FRN)+ges_calc+elev,family=gaussian, id=FIPS,data =  bd)
bw1.res<-bw1.mod
...
#pt270
pt270.mod <- ggee(pterm ~ ta270+pm270+sinetime+costime+age_centered+age_centered_sq+cig_preg+cig_pre+mgrossrent+p_ospace+gender+prev_400+ diab+hyper+lungd+diab_other+prevpret+as.factor(kess)+as.factor(mrn.n)+as.factor(edu_group)+as.factor(byob)+parity+as.factor(FRN),data=bd,family=binomial)
pt270.res<-pt270.mod
#add to table
paper_table$pt.pt270<-0
paper_table$pt.pm270<-0
#ta
paper_table$pt.pt270[1] <- coef(pt270.res)[2,"Estimate"]  #extract Betas
paper_table$pt.pt270[2] <-coef(pt270.res)[2,"Std. Error"] #extract SE
...
paper_table$pt.pt270[5] <-coef(pt270.res)[2,"z value"] #tstat
paper_table$pt.pt270[6] <-coef(pt270.res)[2,"Pr(>|z|)"] #sig
#pm
paper_table$pt.pm270[1] <- coef(pt270.res)[3,"Estimate"]  #extract Betas
paper_table$pt.pm270[2] <-coef(pt270.res)[3,"Std. Error"] #extract SE
...
paper_table$pt.pm270[5] <-coef(pt270.res)[3,"z value"] #tstat
paper_table$pt.pm270[6] <-coef(pt270.res)[3,"Pr(>|z|)"] #sig

#pt90
pt90.mod <- ggee(pterm ~ ta90+pm90+sinetime+costime+age_centered+age_centered_sq+cig_preg+cig_pre+mgrossrent+p_ospace+gender+prev_400+ diab+hyper+lungd+diab_other+prevpret+as.factor(kess)+as.factor(mrn.n)+as.factor(edu_group)+as.factor(byob)+parity+as.factor(FRN),data=bd,family=binomial)
pt90.res<-pt90.mod
#add to table
paper_table$pt.pt90<-0
paper_table$pt.pm90<-0
#ta
paper_table$pt.pt90[1] <- coef(pt90.res)[2,"Estimate"]  #extract Betas
paper_table$pt.pt90[2] <-coef(pt90.res)[2,"Std. Error"] #extract SE
paper_table$pt.pt90[3]<-confint(pt90.mod, method="Wald",'ta90', level=0.95)[1] #for low CI
paper_table$pt.pt90[4]<-confint(pt90.mod, method="Wald",'ta90', level=0.95)[2]  #for high
paper_table$pt.pt90[5] <-coef(pt90.res)[2,"z value"] #tstat
paper_table$pt.pt90[6] <-coef(pt90.res)[2,"Pr(>|z|)"] #sig
#pm
paper_table$pt.pm90[1] <- coef(pt90.res)[3,"Estimate"]  #extract Betas
paper_table$pt.pm90[2] <-coef(pt90.res)[3,"Std. Error"] #extract SE
paper_table$pt.pm90[3]<-confint(pt90.mod, method="Wald",'pm90', level=0.95)[1] #for low CI
paper_table$pt.pm90[4]<-confint(pt90.mod, method="Wald",'pm90', level=0.95)[2]  #for high
paper_table$pt.pm90[5] <-coef(pt90.res)[3,"z value"] #tstat
paper_table$pt.pm90[6] <-coef(pt90.res)[3,"Pr(>|z|)"] #sig


######## low birth weight
#lbw270
lbw270.mod <- ggee(lowbw ~ ta270+pm270+sinetime+costime+age_centered+age_centered_sq+cig_preg+cig_pre+mgrossrent+p_ospace+gender+prev_400+ diab+hyper+lungd+diab_other+prevpret+as.factor(kess)+as.factor(mrn.n)+as.factor(edu_group)+as.factor(byob)+parity+as.factor(FRN),data=bd,family=binomial)
lbw270.res<-lbw270.mod
#add to table
...
#lbw90
lbw90.mod <- ggee(lowbw ~ ta90+pm90+sinetime+costime+age_centered+age_centered_sq+cig_preg+cig_pre+mgrossrent+p_ospace+gender+prev_400+ diab+hyper+lungd+diab_other+prevpret+as.factor(kess)+as.factor(mrn.n)+as.factor(edu_group)+as.factor(byob)+parity+as.factor(FRN),data=bd,family=binomial)
lbw90.res<-lbw90.mod
#add to table
...
sgaq270.mod <- ggee(sgaq ~ ta270+pm270+sinetime+costime+age_centered+age_centered_sq+cig_preg+cig_pre+mgrossrent+p_ospace+gender+prev_400+ diab+hyper+lungd+diab_other+prevpret+as.factor(kess)+as.factor(mrn.n)+as.factor(edu_group)+as.factor(byob)+parity+as.factor(FRN),data=bd,family=binomial)
sgaq270.res<-sgaq270.mod
#add to table
...
sgaq90.mod <- ggee(sgaq ~ ta90+pm90+sinetime+costime+age_centered+age_centered_sq+cig_preg+cig_pre+mgrossrent+p_ospace+gender+prev_400+ diab+hyper+lungd+diab_other+prevpret+as.factor(kess)+as.factor(mrn.n)+as.factor(edu_group)+as.factor(byob)+parity+as.factor(FRN),data=bd,family=binomial)
sgaq90.res<-sgaq90.mod
#add to table
