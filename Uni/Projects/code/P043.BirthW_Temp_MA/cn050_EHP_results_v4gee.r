...
paper_table$pt.pt270[3]<- exp((coef(summary(pt270.res))[2,"Estimate"]-1.96)*(coef(summary(bw270.res))[2,"Naive S.E."]))#for low CI
paper_table$pt.pt270[4]<- exp((coef(summary(pt270.res))[2,"Estimate"]+1.96)*(coef(summary(bw270.res))[2,"Naive S.E."])) #for high
paper_table$pt.pt270[5] <-coef(summary(pt270.res))[2,"Naive z"] #tstat
paper_table$pt.pt270[6] <-2 * pnorm(abs(coef(summary(bw270.res))[2,3]), lower.tail = FALSE) #get sig#sig
...
paper_table$pt.pm270[3]<- exp((coef(summary(pt270.res))[3,"Estimate"]-1.96)*(coef(summary(bw270.res))[3,"Naive S.E."]))#for low CI
paper_table$pt.pm270[4]<- exp((coef(summary(pt270.res))[3,"Estimate"]+1.96)*(coef(summary(bw270.res))[3,"Naive S.E."])) #for high
paper_table$pt.pm270[5] <-coef(summary(pt270.res))[3,"Naive z"] #tstat
paper_table$pt.pm270[6] <-2 * pnorm(abs(coef(summary(bw270.res))[3,3]), lower.tail = FALSE) #get sig#sig
