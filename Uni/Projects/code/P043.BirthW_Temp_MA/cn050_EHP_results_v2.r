...
#pt270
pt270.mod <- glm(pterm ~ ta270+pm270+sinetime+costime+age_centered+age_centered_sq+cig_preg+cig_pre+mgrossrent+p_ospace+gender+prev_400+ diab+hyper+lungd+diab_other+prevpret+as.factor(kess)+as.factor(mrn.n)+as.factor(edu_group)+as.factor(byob)+parity+as.factor(FRN),data=bd,family=binomial)
pt270.res<- summary(pt270.mod)
#add to table
...
#pt90
pt90.mod <- glm(pterm ~ ta90+pm90+sinetime+costime+age_centered+age_centered_sq+cig_preg+cig_pre+mgrossrent+p_ospace+gender+prev_400+ diab+hyper+lungd+diab_other+prevpret+as.factor(kess)+as.factor(mrn.n)+as.factor(edu_group)+as.factor(byob)+parity+as.factor(FRN),data=bd,family=binomial)
pt90.res<- summary(pt90.mod)
#add to table
...
######## low birth weight
#lbw270
lbw270.mod <- glm(lowbw ~ ta270+pm270+sinetime+costime+age_centered+age_centered_sq+cig_preg+cig_pre+mgrossrent+p_ospace+gender+prev_400+ diab+hyper+lungd+diab_other+prevpret+as.factor(kess)+as.factor(mrn.n)+as.factor(edu_group)+as.factor(byob)+parity+as.factor(FRN),data=bd,family=binomial)
...
#lbw90
lbw90.mod <- glm(lowbw ~ ta90+pm90+sinetime+costime+age_centered+age_centered_sq+cig_preg+cig_pre+mgrossrent+p_ospace+gender+prev_400+ diab+hyper+lungd+diab_other+prevpret+as.factor(kess)+as.factor(mrn.n)+as.factor(edu_group)+as.factor(byob)+parity+as.factor(FRN),data=bd,family=binomial)
...
sgaq270.mod <- glm(sgaq ~ ta270+pm270+sinetime+costime+age_centered+age_centered_sq+cig_preg+cig_pre+mgrossrent+p_ospace+gender+prev_400+ diab+hyper+lungd+diab_other+prevpret+as.factor(kess)+as.factor(mrn.n)+as.factor(edu_group)+as.factor(byob)+parity+as.factor(FRN),data=bd,family=binomial)
...
sgaq90.mod <- glm(sgaq ~ ta90+pm90+sinetime+costime+age_centered+age_centered_sq+cig_preg+cig_pre+mgrossrent+p_ospace+gender+prev_400+ diab+hyper+lungd+diab_other+prevpret+as.factor(kess)+as.factor(mrn.n)+as.factor(edu_group)+as.factor(byob)+parity+as.factor(FRN),data=bd,family=binomial)
