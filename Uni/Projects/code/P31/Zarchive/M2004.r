...
#saveRDS(mod3grid.se,"/home/zeltak/smb4k/ZUNISYN/ZUraid/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/FN015_MPM/mod3fullgrid2004.rds")
...
closestaodseT1<- nearestbyday(mod3.m ,pm.m , 
                              mod3grid.seT1, pmall2004 [, list(day,PM25,SiteCode)], 
...
saveRDS(closestaodseT1,"/home/zeltak/smb4k/ZUNISYN/ZUraid/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/FN000_RWORKDIR/closestaodseT1d2004.rds")
rm(closestaodseT1)
gc()
...
closestaodseT2<- nearestbyday(mod3.m ,pm.m , 
                              mod3grid.seT2, pmall2004 [, list(day,PM25,SiteCode)], 
                              "guidc", "SiteCode", "meanPM", "PM25", knearest = 13, maxdistance = NA)
...
saveRDS(closestaodseT2,"/home/zeltak/smb4k/ZUNISYN/ZUraid/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/FN000_RWORKDIR/closestaodseT2d2004.rds")
rm(closestaodseT2)
gc()
...
closestaodseT3<- nearestbyday(mod3.m ,pm.m , 
                              mod3grid.seT3, pmall2004 [, list(day,PM25,SiteCode)], 
                              "guidc", "SiteCode", "meanPM", "PM25", knearest = 13, maxdistance = NA)
...
saveRDS(closestaodseT3,"/home/zeltak/smb4k/ZUNISYN/ZUraid/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/FN000_RWORKDIR/closestaodseT3d2004.rds")
...
closestaodseT4<- nearestbyday(mod3.m ,pm.m , 
                              mod3grid.seT4, pmall2004 [, list(day,PM25,SiteCode)], 
                              "guidc", "SiteCode", "meanPM", "PM25", knearest = 13, maxdistance = NA)
...
saveRDS(closestaodseT4,"/home/zeltak/smb4k/ZUNISYN/ZUraid/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/FN000_RWORKDIR/closestaodseT4d2004.rds")
...
closestaodseT5<- nearestbyday(mod3.m ,pm.m , 
                              mod3grid.seT5, pmall2004 [, list(day,PM25,SiteCode)], 
                              "guidc", "SiteCode", "meanPM", "PM25", knearest = 13, maxdistance = NA)
...
saveRDS(closestaodseT5,"/home/zeltak/smb4k/ZUNISYN/ZUraid/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/FN000_RWORKDIR/closestaodseT5d2004.rds")
...
#bind it
######
closestaodseT1<-readRDS("/home/zeltak/smb4k/ZUNISYN/ZUraid/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/FN000_RWORKDIR/closestaodseT1d2004.rds")
closestaodseT2<-readRDS("/home/zeltak/smb4k/ZUNISYN/ZUraid/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/FN000_RWORKDIR/closestaodseT2d2004.rds")
closestaodseT3<-readRDS("/home/zeltak/smb4k/ZUNISYN/ZUraid/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/FN000_RWORKDIR/closestaodseT3d2004.rds")
closestaodseT4<-readRDS("/home/zeltak/smb4k/ZUNISYN/ZUraid/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/FN000_RWORKDIR/closestaodseT4d2004.rds")
closestaodseT5<-readRDS("/home/zeltak/smb4k/ZUNISYN/ZUraid/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/FN000_RWORKDIR/closestaodseT5d2004.rds")


mpm2004<-rbind(closestaodseT1,closestaodseT2,closestaodseT3,closestaodseT4,closestaodseT5)
#return numric guid
mpm2004[, guid := as.integer(guidc)]
mpm2004[,guidc :=NULL]

saveRDS(mpm2004  , "/home/zeltak/smb4k/ZUNISYN/ZUraid/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/FN015_MPM/mpm2004.rds")
