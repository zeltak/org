...
mod1table <- data.frame(type=character(40), r2004=numeric(40),
...
saveRDS(m2_2004, "/home/zeltak/smb4k/ZUNISYN/ZUraid/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/FN008_model_prep/mod2_2004_pred.m2.rds")
...
saveRDS(m2_agg, "/home/zeltak/smb4k/ZUNISYN/ZUraid/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/FN008_model_prep/m2_agg_2004.rds")
#map the predictions
