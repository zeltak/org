...
# ##############################
# #import grid+mpm
# mpmg<-readRDS("/home/zeltak/smb4k/ZUNISYN/ZUraid/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/FN015_MPM/bestmpm2008.rds")
...
# saveRDS(mod1table, "/home/zeltak/smb4k/ZUNISYN/ZUraid/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/FN000_RWORKDIR/mod1table2008_p2.rds")
# 
...
# Final_pred_2008  = lme(newpred ~ bestmpm ,random = list(guid= ~1 + bestmpm ),control=lmeControl(opt = "optim"),data= m2mpm  )
# 
# #check correlations
...
write.csv(mod3best[, list(LTPM = mean(bestpred, na.rm = T), 
                          ...
                          long_aod =  long_aod[1], lat_aod = lat_aod[1]),by=guid], "/home/zeltak/smb4k/ZUNISYN/ZUraid/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/FN000_RWORKDIR/bestpred2008LPM.csv", row.names = F)
