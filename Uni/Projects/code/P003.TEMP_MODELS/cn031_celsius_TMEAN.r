...
F_T2003_All <-  read.csv("f:/Uni/Projects/3.1.3.TEMP_MODELS/3.1.1.4.Work/3.Analysis/mod1/T2003.csv", header=T) 
...
F_T2003_All$tac=(5/9)*(F_T2003_All$TMEAN-32)
...
write.csv(cvtable,"c:/Users/ekloog/Documents/My Dropbox/uni/~code/3.1.3.3.Code/4.results/t2003_TMEAN.csv")
