...
PROC IMPORT OUT= WORK.grid_2003_bimon1 
            DATAFILE= "f:\Uni\Projects\3.1.3.TEMP_MODELS\3.1.1.4.Work\3.Analysis\mod3_pred\grid_2003_bimon1.dbf" 
            DBMS=DBF REPLACE;
     GETDELETED=NO;
RUN;
...
PROC IMPORT OUT= WORK.grid_2003_bimon2 
            DATAFILE= "f:\Uni\Projects\3.1.3.TEMP_MODELS\3.1.1.4.Work\3.Analysis\mod3_pred\grid_2003_bimon2.dbf" 
            DBMS=DBF REPLACE;
     GETDELETED=NO;
RUN;
...
PROC IMPORT OUT= WORK.grid_2003_bimon3 
            DATAFILE= "f:\Uni\Projects\3.1.3.TEMP_MODELS\3.1.1.4.Work\3.Analysis\mod3_pred\grid_2003_bimon3.dbf" 
            DBMS=DBF REPLACE;
     GETDELETED=NO;
RUN;
...
PROC IMPORT OUT= WORK.grid_2003_bimon4 
            DATAFILE= "f:\Uni\Projects\3.1.3.TEMP_MODELS\3.1.1.4.Work\3.Analysis\mod3_pred\grid_2003_bimon4.dbf" 
            DBMS=DBF REPLACE;
     GETDELETED=NO;
RUN;
...
PROC IMPORT OUT= WORK.grid_2003_bimon5 
            DATAFILE= "f:\Uni\Projects\3.1.3.TEMP_MODELS\3.1.1.4.Work\3.Analysis\mod3_pred\grid_2003_bimon5.dbf" 
            DBMS=DBF REPLACE;
     GETDELETED=NO;
RUN;
...
PROC IMPORT OUT= WORK.grid_2003_bimon6 
            DATAFILE= "f:\Uni\Projects\3.1.3.TEMP_MODELS\3.1.1.4.Work\3.Analysis\mod3_pred\grid_2003_bimon6.dbf" 
            DBMS=DBF REPLACE;
     GETDELETED=NO;
RUN;
...
PROC IMPORT OUT= WORK.T2003_BIMON1 
            DATAFILE= "f:\Uni\Projects\3.1.3.TEMP_MODELS\3.1.1.4.Work\3.Analysis\mod3_pred\t2003_bimon1.csv" 
            DBMS=CSV REPLACE;
     GETNAMES=YES;
     DATAROW=2; 
RUN;
...
PROC IMPORT OUT= WORK.T2003_BIMON2
            DATAFILE= "f:\Uni\Projects\3.1.3.TEMP_MODELS\3.1.1.4.Work\3.Analysis\mod3_pred\t2003_bimon2.csv" 
            DBMS=CSV REPLACE;
     GETNAMES=YES;
     DATAROW=2; 
RUN;
...
PROC IMPORT OUT= WORK.T2003_BIMON3 
            DATAFILE= "f:\Uni\Projects\3.1.3.TEMP_MODELS\3.1.1.4.Work\3.Analysis\mod3_pred\t2003_bimon3.csv" 
            DBMS=CSV REPLACE;
     GETNAMES=YES;
     DATAROW=2; 
RUN;
...
PROC IMPORT OUT= WORK.T2003_BIMON4 
            DATAFILE= "f:\Uni\Projects\3.1.3.TEMP_MODELS\3.1.1.4.Work\3.Analysis\mod3_pred\t2003_bimon4.csv" 
            DBMS=CSV REPLACE;
     GETNAMES=YES;
     DATAROW=2; 
RUN;
...
PROC IMPORT OUT= WORK.T2003_BIMON5 
            DATAFILE= "f:\Uni\Projects\3.1.3.TEMP_MODELS\3.1.1.4.Work\3.Analysis\mod3_pred\t2003_bimon5.csv" 
            DBMS=CSV REPLACE;
     GETNAMES=YES;
     DATAROW=2; 
RUN;
...
PROC IMPORT OUT= WORK.T2003_BIMON6 
            DATAFILE= "f:\Uni\Projects\3.1.3.TEMP_MODELS\3.1.1.4.Work\3.Analysis\mod3_pred\t2003_bimon6.csv" 
            DBMS=CSV REPLACE;
     GETNAMES=YES;
     DATAROW=2; 
RUN;
...
proc univariate data=T2003allbimon_v2;
var mixpred;
run;
