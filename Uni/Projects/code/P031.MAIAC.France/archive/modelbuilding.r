...
m1.all <-readRDS("/media/NAS/Uni/Projects/P031_MAIAC_France/2.work/WORKDIR/mod1.AQ.2005.PM25.c1.rds")
...
m1.formula <- as.formula(pm25 ~ aod+tempa.s+Raina.s+WSa.s+elev.s+tden.s+pden.s+ndvi.s+dist2A1.s+dair+dport+dist_train+dist.aroad+dist.coast+dist.wb+p.agric+p.urban+ p.forest
                     +  NO2+NMVOC+SO2+NH3+PM2.5+PM10+CO+
                         (1+aod|day/region))

  
m1.formula <- as.formula(pm25 ~ aod+tempa.s+WSa.s+elev.s+tden.s+pden.s+ndvi.s+dair+dport+dist_train+dist.aroad+dist.coast+dist.wb+p.agric+p.urban+ p.forest
                     +  NO2+SO2+PM2.5+PM10+(1+aod|day/region))                    

  
m1.formula <- as.formula(pm25 ~ aod+tempa.s+WSa.s+elev.s+tden.s+pden.s+ndvi.s+PBL+dair+dport+dist_train+dist.aroad+dist.coast+dist.wb+p.agric+p.urban+ p.forest
                     +  NO2+SO2+PM2.5+PM10+(1+aod|day/region))  
