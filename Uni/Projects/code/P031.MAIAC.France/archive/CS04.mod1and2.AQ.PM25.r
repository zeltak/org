...
m1.all <-readRDS("/media/NAS/Uni/Projects/P031_MAIAC_France/2.work/WORKDIR/mod1.AQ.2003.PM10.rds")
...
#for data
m1.formula <- as.formula(pm10~ aod+tempa.s+Raina.s+WSa.s++elev.s+tden.s+pden.s+ndvi.s +p_urb.s+dist2A1.s                                   +(1+aod|day)) 
