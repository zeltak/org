...
#saveRDS(db,paste("/media/NAS/Uni/Projects/P031_MAIAC_France/2.work/WORKDIR/tmpdb.",y,".rds",sep=""))
  ...
  #PM
  PM25<-fread(paste("/media/NAS/Uni/Projects/P031_MAIAC_France/1.RAW/PM/ PM25_ ",y," .csv",sep=""))
  PM25$day<-as.Date(PM25$Date)
  PM25$c<-year(PM25$day)
  PM25<-filter(PM25,c==y)
  setnames(PM25,"long","long_pm25");PM25$long_pm25<-as.numeric(PM25$long_pm25)
  setnames(PM25,"lat","lat_pm25");PM25$lat_pm25<-as.numeric(PM25$lat_pm25)
  setnames(PM25,"PMconc","pm25")
  setnames(PM25,"CODESTATION","stn")
PM25<-na.omit(PM25) 

   PM10<-fread(paste("/media/NAS/Uni/Projects/P031_MAIAC_France/1.RAW/PM/ PM10_ ",y," .csv",sep=""))
  PM10$day<-as.Date(PM10$Date)
  PM10$c<-year(PM10$day)
  PM10<-filter(PM10,c==y)
  setnames(PM10,"long","long_pm10"); PM10$long_pm10<-as.numeric(PM10$long_pm10)
  setnames(PM10,"lat","lat_pm10"); PM10$lat_pm10<-as.numeric(PM10$lat_pm10)
  setnames(PM10,"PMconc","pm10")
  setnames(PM10,"CODESTATION","stn")
PM10<-na.omit(PM10) 
