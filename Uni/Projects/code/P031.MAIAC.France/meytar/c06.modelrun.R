...
###base model pm10
m1.raw.formula <- as.formula(pm10~ aod)
m1_sc <- lm(m1.raw.formula,data=mod1.pm10)
summary(m1_sc)
mod1.pm10$pred.m1 <- predict(m1_sc)
print(summary(lm(pm10~pred.m1,data=mod1.pm10))$r.squared)
...
m1_sc <- lmer(m1.formula,data=mod1.pm10)
summary(m1_sc)
mod1.pm10$pred.m1 <- predict(m1_sc)
print(summary(lm(pm10~pred.m1,data=mod1.pm10))$r.squared)
