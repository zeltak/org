...
###########  #import LU
lu1<- fread("/media/NAS/Uni/Projects/P031_MAIAC_France/1.RAW/LU/merge_data.csv")
...
#flag grids with very low aod count
...
#flag low AOD retrival days ('1' is a low retrival day)
f<- m9.m2 %>%
    group_by(aodid) %>%
