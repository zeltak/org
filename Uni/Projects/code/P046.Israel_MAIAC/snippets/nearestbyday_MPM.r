...
nearestbydayMEAN <- function(matrix1, matrix2, dt1, dt2, dt1varname, dt2varname,
  ...
  # store the number of valid observations and mean
  dt2long[, newfields := list(.N, mean(get(varstoget), na.rm = T)), by=c(dt1varname,"day"), with = F]
