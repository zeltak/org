...
m1.all <-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/Xmod1C.AQ.PM10.rds")
...
res[res$type=="PM10", 'm1.raw.space'] <- print(summary(lm(PM10~pred.m1,data=m1.all))$r.squared)
...
res[res$type=="PM10", 'm1.raw.time'] <-print(summary(lm(delpm ~ delpred, data=tempoall))$r.squared)
...
spatialall<-m1.all %>%
    ...
    summarise(barpm = mean(PM10, na.rm=TRUE), barpred = mean(pred.m1, na.rm=TRUE)) 
m1.fit.all.s <- lm(barpm ~ barpred, data=spatialall)
res[res$type=="PM10", 'm1.space.space'] <-print(summary(lm(barpm ~ barpred, data=spatialall))$r.squared)
...
tempoall$delpred <-tempoall$pred.m1-tempoall$barpred
mod_temporal <- lm(delpm ~ delpred, data=tempoall)
res[res$type=="PM10", 'm1.space.time'] <-print(summary(lm(delpm ~ delpred, data=tempoall))$r.squared)
...
m1.all[,pred.m1 := NULL]
m1.all$pred.m1 <- predict(m1_sc)
res[res$type=="PM10", 'm1.time'] <- print(summary(lm(PM10~pred.m1,data=m1.all))$r.squared)
#spatial
spatialall<-m1.all %>%
    group_by(stn) %>%
    summarise(barpm = mean(PM10, na.rm=TRUE), barpred = mean(pred.m1, na.rm=TRUE)) 
m1.fit.all.s <- lm(barpm ~ barpred, data=spatialall)
res[res$type=="PM10", 'm1.time.space'] <- print(summary(lm(barpm ~ barpred, data=spatialall))$r.squared)
#temporal
tempoall<-left_join(m1.all,spatialall)
tempoall$delpm <-tempoall$PM10-tempoall$barpm
tempoall$delpred <-tempoall$pred.m1-tempoall$barpred
mod_temporal <- lm(delpm ~ delpred, data=tempoall)
res[res$type=="PM10", 'm1.time.time'] <- print(summary(lm(delpm ~ delpred, data=tempoall))$r.squared)


#for paper noaod
m1.formula <- as.formula(PM10~ +tempa.s+WSa.s
                        +pbldag
                        +RHa.s+O3a.s+Raina.s+NOa.s 
                         +ndvi.s 
                        +elev.s+tden.s
...
m1.all[,pred.m1 := NULL]
m1.all$pred.m1 <- predict(m1_sc)
res[res$type=="PM10", 'm1.noaod'] <- print(summary(lm(PM10~pred.m1,data=m1.all))$r.squared)
#spatial
spatialall<-m1.all %>%
    group_by(stn) %>%
    summarise(barpm = mean(PM10, na.rm=TRUE), barpred = mean(pred.m1, na.rm=TRUE)) 
m1.fit.all.s <- lm(barpm ~ barpred, data=spatialall)
res[res$type=="PM10", 'm1.noaod.space'] <- print(summary(lm(barpm ~ barpred, data=spatialall))$r.squared)
#temporal
tempoall<-left_join(m1.all,spatialall)
tempoall$delpm <-tempoall$PM10-tempoall$barpm
tempoall$delpred <-tempoall$pred.m1-tempoall$barpred
mod_temporal <- lm(delpm ~ delpred, data=tempoall)
res[res$type=="PM10", 'm1.noaod.time'] <- print(summary(lm(delpm ~ delpred, data=tempoall))$r.squared)
...
#for data
#m1.formula <- as.formula(PM10~ aod+tempa.s+pbldag+elev.s+tden.s+pden.s+ndvi.s +p_os.s +(1+aod|day/reg_num)) 
...
saveRDS(m1.all,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/Xmod1C.AQ.PM10.pred.rds")
...
saveRDS(m1.all.cv,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/Xmod1cv.AQ.PM10.rds")
...
res[res$type=="PM10", 'm1cvloc.rmspe.space'] <- print(rmse(residuals(m1.fit.all.cv.loc.s)))
...
saveRDS(res, "/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/resm1.AQ.PM10.rds")
...
saveRDS(m2.all,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/Xmod2.AQ.PM10.pred.rds")
...
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.PM10.2003.pred3.rds")
...
#recode negative into zero
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.PM10.2004.pred3.rds")
...
saveRDS(mod3,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.PM10.2005.pred3.rds")
#clean
keep(m2.all,data.m3,mod3,res,rmse, sure=TRUE) 
gc()
#2006
...
#recode negative into zero
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.PM10.2006.pred3.rds")
...
#recode negative into zero
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.PM10.2007.pred3.rds")
...
#recode negative into zero
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.PM10.2008.pred3.rds")
...
#recode negative into zero
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.PM10.2009.pred3.rds")
...
#recode negative into zero
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.PM10.2010.pred3.rds")
...
#recode negative into zero
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.PM10.2011.pred3.rds")
...
#recode negative into zero
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.PM10.2012.pred3.rds")
...
#recode negative into zero
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.PM10.2013.pred3.rds")
...
data.m3.2003<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.PM10.2003.pred3.rds")
data.m3.2004<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.PM10.2004.pred3.rds")
data.m3.2005<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.PM10.2005.pred3.rds")
data.m3.2006<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.PM10.2006.pred3.rds")
data.m3.2007<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.PM10.2007.pred3.rds")
data.m3.2008<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.PM10.2008.pred3.rds")
data.m3.2009<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.PM10.2009.pred3.rds")
data.m3.2010<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.PM10.2010.pred3.rds")
data.m3.2011<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.PM10.2011.pred3.rds")
data.m3.2012<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.PM10.2012.pred3.rds")
data.m3.2013<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.PM10.2013.pred3.rds")
...
saveRDS(res, "/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/resALL.AQ.PM10.rds")

#########################
#import mod2
mod2<- readRDS( "/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/Xmod2.AQ.PM10.pred.rds")
...
#save
saveRDS(mod3best,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/Xmod3.AQ.PM10.bestpred.rds")
...
write.csv(mod3best[, list(LTPM = mean(bestpred, na.rm = T), 
                          ...
                          x_aod_ITM =  x_aod_ITM[1], y_aod_ITM = y_aod_ITM[1]),by=aodid], "/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/Xmod3.AQ.PM10.LTPM.csv", row.names = F)


write.csv(res,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/resALL.AQ.PM10.csv")
...
# plot a single year by day
ggplot(m1.all[stn %in% c("BHD") & c == 2008,], aes(x = day)) + 
  geom_line(aes(y = PM10), color = "blue", alpha = 0.15) + 
  geom_point(aes(y = PM10), color = "blue", alpha = 0.7, size = 0.8) + 
  geom_point(aes(y = pred.m3), color = "red", alpha = 0.7, size = 0.8) + 
  geom_smooth(aes(y = pred.m3), color = "red", linetype = "dashed", width = 1.2, se = F) + 
  geom_smooth(aes(y = PM10), color = "blue", se = F) + 
  ylab(expression(paste(PM[2.5], "concentration (ug/", m^3, ")"))) + 
  theme_bw() + theme(axis.title.x = element_blank())
#ggsave("~/Dropbox/mex_air/figures/example_timeseries.png", width = 5.5, height = 3)
...
# plot a single year by day
ggplot(m1.all[stn %in% c("REH") & c == 2008,], aes(x = day)) + 
  geom_line(aes(y = PM10), color = "blue", alpha = 0.15) + 
  geom_point(aes(y = PM10), color = "blue", alpha = 0.7, size = 0.8) + 
  geom_point(aes(y = pred.m3), color = "red", alpha = 0.7, size = 0.8) + 
  #geom_smooth(aes(y = pred.m3), color = "red", linetype = "dashed", width = 1.2, se = F) + 
