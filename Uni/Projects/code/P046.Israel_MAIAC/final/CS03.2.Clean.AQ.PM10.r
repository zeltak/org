...
m1.all <-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/Xmod1.AQ.PM10.rds")
...
# PM10<-PM10[PM10 > 0.000000000001 & PM10 < 900 ]
...
# setkey(PM10,stn,day)
# setkey(PM10,stn,day)
# PM.j=merge(PM10,PM10,by=c("stn","day"))
# #leave only stations with both PM2.5 and PM 10 measurements
# PM.j=na.omit(PM.j)
# PM.j$ratio=PM.j[,PM10]/PM.j[,PM10]
...
saveRDS(m1.all,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/Xmod1C.AQ.PM10.rds")
