...
allbestpred<-read.csv("/media/NAS/Uni/Projects/P046_Israel_MAIAC/0.raw/maiac_aod/MAIACAqIsr_2012.csv" ,header=T)
...
#saveRDS(clippedaod,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN003_AOd_allyears/AOD_2012_test.RDS")
