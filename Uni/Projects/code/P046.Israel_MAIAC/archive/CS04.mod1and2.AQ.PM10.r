...
m1.all <-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/Xmod1C.PM10.AQ.rds")
...
res[res$type=="PM10", 'm1.raw'] <- print(summary(lm(PM10~pred.m1,data=m1.all))$r.squared)
...
m1.all$pred.m1 <- predict(m1_sc)
print(summary(lm(PM10~pred.m1,data=m1.all))$r.squared)
res[res$type=="PM10", 'm1.space'] <- print(summary(lm(PM10~pred.m1,data=m1.all))$r.squared)
...
m1.all$pred.m1 <- predict(m1_sc)
print(summary(lm(PM10~pred.m1,data=m1.all))$r.squared)
res[res$type=="PM10", 'm1.temp'] <- print(summary(lm(PM10~pred.m1,data=m1.all))$r.squared)
#spatial
spatialall<-m1.all %>%
    group_by(stn) %>%
    summarise(barpm = mean(PM10, na.rm=TRUE), barpred = mean(pred.m1, na.rm=TRUE)) 
...
# m1.formula <- as.formula(PM10~ tempa.s
#                         +pbldag
#                           +elev.s+tden.s
#                         +pden.s
#                         +ndvi.s 
...
#RMSPE
res[res$type=="PM10", 'm1.PE'] <- print(rmse(residuals(m1_sc)))
...
saveRDS(m1.all,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/Xmod1C.pred.PM10.AQ.rds")
...
res[res$type=="PM10", 'm1cv.I.se'] <-print(summary(lm(PM10~pred.m1.cv,data=m1.all.cv))$coef[1,2])
res[res$type=="PM10", 'm1cv.S'] <-print(summary(lm(PM10~pred.m1.cv,data=m1.all.cv))$coef[2,1])
res[res$type=="PM10", 'm1cv.S.se'] <-print(summary(lm(PM10~pred.m1.cv,data=m1.all.cv))$coef[2,2])
#RMSPE
res[res$type=="PM10", 'm1cv.PE'] <- print(rmse(residuals(m1.fit.all.cv)))
...
res[res$type=="PM10", 'm1cv.R2.s'] <-  print(summary(lm(barpm ~ barpred, data=spatialall.cv))$r.squared)
res[res$type=="PM10", 'm1cv.PE.s'] <- print(rmse(residuals(m1.fit.all.cv.s)))
...
res[res$type=="PM10", 'm1cv.R2.t'] <-  print(summary(lm(delpm ~ delpred, data=tempoall.cv))$r.squared)
...
res[res$type=="PM10", 'm1cv.loc.R2'] <- print(summary(lm(PM10~pred.m1.both,data=m1.all.cv.loc))$r.squared)
res[res$type=="PM10", 'm1cv.loc.I'] <-print(summary(lm(PM10~pred.m1.both,data=m1.all.cv.loc))$coef[1,1])
res[res$type=="PM10", 'm1cv.loc.I.se'] <-print(summary(lm(PM10~pred.m1.both,data=m1.all.cv.loc))$coef[1,2])
res[res$type=="PM10", 'm1cv.loc.S'] <-print(summary(lm(PM10~pred.m1.both,data=m1.all.cv.loc))$coef[2,1])
res[res$type=="PM10", 'm1cv.loc.S.se'] <-print(summary(lm(PM10~pred.m1.both,data=m1.all.cv.loc))$coef[2,2])
#RMSPE
res[res$type=="PM10", 'm1cv.loc.PE'] <- print(rmse(residuals(m1.fit.all.cv)))
...
res[res$type=="PM10", 'm1cv.loc.R2.s'] <-  print(summary(lm(barpm ~ barpred, data=spatialall.cv.loc))$r.squared)
res[res$type=="PM10", 'm1cv.loc.PE.s'] <- print(rmse(residuals(m1.fit.all.cv.loc.s)))
...
res[res$type=="PM10", 'm1cv.loc.R2.t'] <-  print(summary(lm(delpm ~ delpred, data=tempoall.loc.cv))$r.squared)
...
saveRDS(m2.all,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/Xmod2.pred2.AQ.PM10.rds")
saveRDS(res,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/res.AQ.PM10.rds")
...
print(summary(lm(PM10~pred.m2,data=m1.all))$r.squared)


#-------------->prepare for mod3
m2.all[, bimon := (m + 1) %/% 2]
setkey(m2.all,day, aodid)
m2.all<-m2.all[!is.na(meanPM10)]
...
#in israel check per month, also check 30km band and other methods for meanPM10
m2.smooth = lme(pred.m2 ~ meanPM10,random = list(aodid= ~1 + meanPM10),control=lmeControl(opt = "optim"), data= m2.all.2003 )
...
Final_pred_all <- lme(pred.t32 ~ meanPM10 ,random = list(aodid= ~1 + meanPM10 ),control=lmeControl(opt = "optim"),data= m2.all.2003  )
...
#for PM10
data.m3.2003 <- select(data.m3.2003,day,aodid,m,meanPM10,x_aod_ITM,y_aod_ITM)
data.m3.2003[, bimon := (m + 1) %/% 2]
setkey(data.m3.2003,day, aodid)
data.m3.2003<-data.m3.2003[!is.na(meanPM10)]
...
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.2003.pred3.PM10.rds")
...
#run the lmer part regressing stage 2 pred Vs mean pm
#in israel check per month, also check 30km band and other methods for meanPM10
m2.smooth = lme(pred.m2 ~ meanPM10,random = list(aodid= ~1 + meanPM10),control=lmeControl(opt = "optim"), data= m2.all.2004 )
#correlate to see everything from mod2 and the mpm works
...
#rerun the lme on the predictions including the spatial spline (smooth)
Final_pred_all <- lme(pred.t32 ~ meanPM10 ,random = list(aodid= ~1 + meanPM10 ),control=lmeControl(opt = "optim"),data= m2.all.2004  )
...
#for PM10
data.m3.2004 <- select(data.m3.2004,day,aodid,m,meanPM10,x_aod_ITM,y_aod_ITM)
data.m3.2004[, bimon := (m + 1) %/% 2]
setkey(data.m3.2004,day, aodid)
data.m3.2004<-data.m3.2004[!is.na(meanPM10)]
#generate m.3 initial pred
...
#recode negative into zero
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.2004.pred3.PM10.rds")
...
#run the lmer part regressing stage 2 pred Vs mean pm
#in israel check per month, also check 30km band and other methods for meanPM10
m2.smooth = lme(pred.m2 ~ meanPM10,random = list(aodid= ~1 + meanPM10),control=lmeControl(opt = "optim"), data= m2.all.2005 )
#correlate to see everything from mod2 and the mpm works
...
#rerun the lme on the predictions including the spatial spline (smooth)
Final_pred_all <- lme(pred.t32 ~ meanPM10 ,random = list(aodid= ~1 + meanPM10 ),control=lmeControl(opt = "optim"),data= m2.all.2005  )
...
#for PM10
data.m3.2005 <- select(data.m3.2005,day,aodid,m,meanPM10,x_aod_ITM,y_aod_ITM)
data.m3.2005[, bimon := (m + 1) %/% 2]
setkey(data.m3.2005,day, aodid)
data.m3.2005<-data.m3.2005[!is.na(meanPM10)]
#generate m.3 initial pred
...
#run the lmer part regressing stage 2 pred Vs mean pm
#in israel check per month, also check 30km band and other methods for meanPM10
m2.smooth = lme(pred.m2 ~ meanPM10,random = list(aodid= ~1 + meanPM10),control=lmeControl(opt = "optim"), data= m2.all.2006 )
#correlate to see everything from mod2 and the mpm works
...
#rerun the lme on the predictions including the spatial spline (smooth)
Final_pred_all <- lme(pred.t32 ~ meanPM10 ,random = list(aodid= ~1 + meanPM10 ),control=lmeControl(opt = "optim"),data= m2.all.2006  )
...
#for PM10
data.m3.2006 <- select(data.m3.2006,day,aodid,m,meanPM10,x_aod_ITM,y_aod_ITM)
data.m3.2006[, bimon := (m + 1) %/% 2]
setkey(data.m3.2006,day, aodid)
data.m3.2006<-data.m3.2006[!is.na(meanPM10)]
#generate m.3 initial pred
...
#recode negative into zero
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.2006.pred3.PM10.rds")
...
#run the lmer part regressing stage 2 pred Vs mean pm
#in israel check per month, also check 30km band and other methods for meanPM10
m2.smooth = lme(pred.m2 ~ meanPM10,random = list(aodid= ~1 + meanPM10),control=lmeControl(opt = "optim"), data= m2.all.2007 )
#correlate to see everything from mod2 and the mpm works
...
#rerun the lme on the predictions including the spatial spline (smooth)
Final_pred_all <- lme(pred.t32 ~ meanPM10 ,random = list(aodid= ~1 + meanPM10 ),control=lmeControl(opt = "optim"),data= m2.all.2007  )
...
#for PM10
data.m3.2007 <- select(data.m3.2007,day,aodid,m,meanPM10,x_aod_ITM,y_aod_ITM)
data.m3.2007[, bimon := (m + 1) %/% 2]
setkey(data.m3.2007,day, aodid)
data.m3.2007<-data.m3.2007[!is.na(meanPM10)]
#generate m.3 initial pred
...
#recode negative into zero
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.2007.pred3.PM10.rds")
...
#run the lmer part regressing stage 2 pred Vs mean pm
#in israel check per month, also check 30km band and other methods for meanPM10
m2.smooth = lme(pred.m2 ~ meanPM10,random = list(aodid= ~1 + meanPM10),control=lmeControl(opt = "optim"), data= m2.all.2008 )
#correlate to see everything from mod2 and the mpm works
...
#rerun the lme on the predictions including the spatial spline (smooth)
Final_pred_all <- lme(pred.t32 ~ meanPM10 ,random = list(aodid= ~1 + meanPM10 ),control=lmeControl(opt = "optim"),data= m2.all.2008  )
...
#for PM10
data.m3.2008 <- select(data.m3.2008,day,aodid,m,meanPM10,x_aod_ITM,y_aod_ITM)
data.m3.2008[, bimon := (m + 1) %/% 2]
setkey(data.m3.2008,day, aodid)
data.m3.2008<-data.m3.2008[!is.na(meanPM10)]
#generate m.3 initial pred
...
#recode negative into zero
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.2008.pred3.PM10.rds")
...
#run the lmer part regressing stage 2 pred Vs mean pm
#in israel check per month, also check 30km band and other methods for meanPM10
m2.smooth = lme(pred.m2 ~ meanPM10,random = list(aodid= ~1 + meanPM10),control=lmeControl(opt = "optim"), data= m2.all.2009 )
#correlate to see everything from mod2 and the mpm works
...
#rerun the lme on the predictions including the spatial spline (smooth)
Final_pred_all <- lme(pred.t32 ~ meanPM10 ,random = list(aodid= ~1 + meanPM10 ),control=lmeControl(opt = "optim"),data= m2.all.2009  )
...
#for PM10
data.m3.2009 <- select(data.m3.2009,day,aodid,m,meanPM10,x_aod_ITM,y_aod_ITM)
data.m3.2009[, bimon := (m + 1) %/% 2]
setkey(data.m3.2009,day, aodid)
data.m3.2009<-data.m3.2009[!is.na(meanPM10)]
#generate m.3 initial pred
...
#recode negative into zero
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.2009.pred3.PM10.rds")
...
#run the lmer part regressing stage 2 pred Vs mean pm
#in israel check per month, also check 30km band and other methods for meanPM10
m2.smooth = lme(pred.m2 ~ meanPM10,random = list(aodid= ~1 + meanPM10),control=lmeControl(opt = "optim"), data= m2.all.2010 )
#correlate to see everything from mod2 and the mpm works
...
#rerun the lme on the predictions including the spatial spline (smooth)
Final_pred_all <- lme(pred.t32 ~ meanPM10 ,random = list(aodid= ~1 + meanPM10 ),control=lmeControl(opt = "optim"),data= m2.all.2010  )
...
#for PM10
data.m3.2010 <- select(data.m3.2010,day,aodid,m,meanPM10,x_aod_ITM,y_aod_ITM)
data.m3.2010[, bimon := (m + 1) %/% 2]
setkey(data.m3.2010,day, aodid)
data.m3.2010<-data.m3.2010[!is.na(meanPM10)]
#generate m.3 initial pred
...
#recode negative into zero
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.2010.pred3.PM10.rds")
...
#run the lmer part regressing stage 2 pred Vs mean pm
#in israel check per month, also check 30km band and other methods for meanPM10
m2.smooth = lme(pred.m2 ~ meanPM10,random = list(aodid= ~1 + meanPM10),control=lmeControl(opt = "optim"), data= m2.all.2011 )
#correlate to see everything from mod2 and the mpm works
...
#rerun the lme on the predictions including the spatial spline (smooth)
Final_pred_all <- lme(pred.t32 ~ meanPM10 ,random = list(aodid= ~1 + meanPM10 ),control=lmeControl(opt = "optim"),data= m2.all.2011  )
...
#for PM10
data.m3.2011 <- select(data.m3.2011,day,aodid,m,meanPM10,x_aod_ITM,y_aod_ITM)
data.m3.2011[, bimon := (m + 1) %/% 2]
setkey(data.m3.2011,day, aodid)
data.m3.2011<-data.m3.2011[!is.na(meanPM10)]
#generate m.3 initial pred
...
#recode negative into zero
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.2011.pred3.PM10.rds")
...
#run the lmer part regressing stage 2 pred Vs mean pm
#in israel check per month, also check 30km band and other methods for meanPM10
m2.smooth = lme(pred.m2 ~ meanPM10,random = list(aodid= ~1 + meanPM10),control=lmeControl(opt = "optim"), data= m2.all.2012 )
#correlate to see everything from mod2 and the mpm works
...
#rerun the lme on the predictions including the spatial spline (smooth)
Final_pred_all <- lme(pred.t32 ~ meanPM10 ,random = list(aodid= ~1 + meanPM10 ),control=lmeControl(opt = "optim"),data= m2.all.2012  )
...
#for PM10
data.m3.2012 <- select(data.m3.2012,day,aodid,m,meanPM10,x_aod_ITM,y_aod_ITM)
data.m3.2012[, bimon := (m + 1) %/% 2]
setkey(data.m3.2012,day, aodid)
data.m3.2012<-data.m3.2012[!is.na(meanPM10)]
#generate m.3 initial pred
...
#recode negative into zero
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.2012.pred3.PM10.rds")
...
#run the lmer part regressing stage 2 pred Vs mean pm
#in israel check per month, also check 30km band and other methods for meanPM10
m2.smooth = lme(pred.m2 ~ meanPM10,random = list(aodid= ~1 + meanPM10),control=lmeControl(opt = "optim"), data= m2.all.2013 )
#correlate to see everything from mod2 and the mpm works
...
#rerun the lme on the predictions including the spatial spline (smooth)
Final_pred_all <- lme(pred.t32 ~ meanPM10 ,random = list(aodid= ~1 + meanPM10 ),control=lmeControl(opt = "optim"),data= m2.all.2013  )
...
#for PM10
data.m3.2013 <- select(data.m3.2013,day,aodid,m,meanPM10,x_aod_ITM,y_aod_ITM)
data.m3.2013[, bimon := (m + 1) %/% 2]
setkey(data.m3.2013,day, aodid)
data.m3.2013<-data.m3.2013[!is.na(meanPM10)]
#generate m.3 initial pred
...
#recode negative into zero
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.2013.pred3.PM10.rds")
...
data.m3.2003<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.2003.pred3.PM10.rds")
data.m3.2004<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.2004.pred3.PM10.rds")
data.m3.2005<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.2005.pred3.PM10.rds")
data.m3.2006<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.2006.pred3.PM10.rds")
data.m3.2007<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.2007.pred3.PM10.rds")
data.m3.2008<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.2008.pred3.PM10.rds")
data.m3.2009<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.2009.pred3.PM10.rds")
data.m3.2010<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.2010.pred3.PM10.rds")
data.m3.2011<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.2011.pred3.PM10.rds")
data.m3.2012<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.2012.pred3.PM10.rds")
data.m3.2013<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3.AQ.2013.pred3.PM10.rds")
...
#########################
#load mod1
m1.all <-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/Xmod1C.pred.PM10.AQ.rds")
m1.all[,aodid:= paste(m1.all$long_aod.x,m1.all$lat_aod.x,sep="-")]
...
#RMSPE
res[res$type=="PM10", 'm3.PE'] <- print(rmse(residuals(m3.fit.all)))


res[res$type=="PM10", 'm1cv.S'] <-print(summary(lm(PM10~pred.m3,data=m1.all))$coef[2,1])
...
res[res$type=="PM10", 'm3.R2.s'] <-  print(summary(lm(barpm ~ barpred, data=spatialall))$r.squared)
res[res$type=="PM10", 'm3.PE.s'] <- print(rmse(residuals(m1.fit.all.spat)))
...
mod_temporal <- lm(delpm ~ delpred, data=tempoall)
res[res$type=="PM10", 'm3.R2.t'] <-  print(summary(lm(delpm ~ delpred, data=tempoall))$r.squared)


saveRDS(res, "/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/resALL.PM10.AQ.rds")
...
#save
saveRDS(mod3best,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/Xmod3.bestpred.PM10.AQ.rds")
#summary(mod3best)
#save for GIS
...
write.csv(mod3best[, list(LTPM = mean(bestpred, na.rm = T), 
                          ...
                          x_aod_ITM =  x_aod_ITM[1], y_aod_ITM = y_aod_ITM[1]),by=aodid], "/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/Xmod3.LTPM.PM10.AQ.csv", row.names = F)
