...
m2.smooth = lme(pred.m2 ~ meanPM,random = list(aodid= ~1 + meanPM),control=lmeControl(opt = "optim"), data= m2.2003 )
#xm2.smooth = lmer(pred.m2 ~ meanPM+(1+ meanPM|aodid), data= m2.2003 )
...
Final_pred_2003 <- lme(pred.t32 ~ meanPM ,random = list(aodid= ~1 + meanPM ),control=lmeControl(opt = "optim"),data= m2.2003  )
...
m3.fit.2003<- summary(lm(PM25~pred.m3,data=m1.2003))
res[res$year=="2003", 'm3.R2'] <- print(summary(lm(PM25~pred.m3,data=m1.2003))$r.squared)    
#RMSPE
...
#save
saveRDS(mod3best,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3best_2003.rds")
...
ggsave(file="/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/LTPM.2003.m3.png")
...
write.csv(mod3best[, list(LTPM = mean(bestpred, na.rm = T), 
                          ...
                          x_aod_ITM =  x_aod_ITM[1], y_aod_ITM = y_aod_ITM[1]),by=aodid], "/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/FINALLTPM.2003.csv", row.names = F)
...
m2.2004<-m2.2004[!is.na(meanPM)]



#run the lmer part regressing stage 2 pred Vs mean pm
#in israel check per month, also check 30km band and other methods for meanpm
m2.smooth = lme(pred.m2 ~ meanPM,random = list(aodid= ~1 + meanPM),control=lmeControl(opt = "optim"), data= m2.2004 )
#xm2.smooth = lmer(pred.m2 ~ meanPM+(1+ meanPM|aodid), data= m2.2004 )
#correlate to see everything from mod2 and the mpm works
...
#rerun the lme on the predictions including the spatial spline (smooth)
Final_pred_2004 <- lme(pred.t32 ~ meanPM ,random = list(aodid= ~1 + meanPM ),control=lmeControl(opt = "optim"),data= m2.2004  )
...
m3.fit.2004<- summary(lm(PM25~pred.m3,data=m1.2004))
res[res$year=="2004", 'm3.R2'] <- print(summary(lm(PM25~pred.m3,data=m1.2004))$r.squared)    
#RMSPE
...
mod3best[!is.na(pred.m1),bestpred := pred.m1]
#save
saveRDS(mod3best,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3best_2004.rds")
...
ggsave(file="/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/LTPM.2004.m3.png")
...
write.csv(mod3best[, list(LTPM = mean(bestpred, na.rm = T), 
                          ...
                          npred.m2 = sum(!is.na(pred.m2)),
                          npred.m3 = sum(!is.na(pred.m3)),
                          x_aod_ITM =  x_aod_ITM[1], y_aod_ITM = y_aod_ITM[1]),by=aodid], "/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/FINALLTPM.2004.csv", row.names = F)
...
glance(lm(PM25~predicted,data=m1.2005))
#get rid of missing
...
m2.2005<-m2.2005[!is.na(meanPM)]



#run the lmer part regressing stage 2 pred Vs mean pm
#in israel check per month, also check 30km band and other methods for meanpm
m2.smooth = lme(pred.m2 ~ meanPM,random = list(aodid= ~1 + meanPM),control=lmeControl(opt = "optim"), data= m2.2005 )
#xm2.smooth = lmer(pred.m2 ~ meanPM+(1+ meanPM|aodid), data= m2.2005 )
#correlate to see everything from mod2 and the mpm works
...
#rerun the lme on the predictions including the spatial spline (smooth)
Final_pred_2005 <- lme(pred.t32 ~ meanPM ,random = list(aodid= ~1 + meanPM ),control=lmeControl(opt = "optim"),data= m2.2005  )
...
m3.fit.2005<- summary(lm(PM25~pred.m3,data=m1.2005))
res[res$year=="2005", 'm3.R2'] <- print(summary(lm(PM25~pred.m3,data=m1.2005))$r.squared)    
#RMSPE
...
mod3best[!is.na(pred.m1),bestpred := pred.m1]
#save
saveRDS(mod3best,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3best_2005.rds")
...
ggsave(file="/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/LTPM.2005.m3.png")
...
write.csv(mod3best[, list(LTPM = mean(bestpred, na.rm = T), 
                          ...
                          npred.m2 = sum(!is.na(pred.m2)),
                          npred.m3 = sum(!is.na(pred.m3)),
                          x_aod_ITM =  x_aod_ITM[1], y_aod_ITM = y_aod_ITM[1]),by=aodid], "/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/FINALLTPM.2005.csv", row.names = F)
...
glance(lm(PM25~predicted,data=m1.2006))
#get rid of missing
...
m2.2006<-m2.2006[!is.na(meanPM)]



#run the lmer part regressing stage 2 pred Vs mean pm
#in israel check per month, also check 30km band and other methods for meanpm
m2.smooth = lme(pred.m2 ~ meanPM,random = list(aodid= ~1 + meanPM),control=lmeControl(opt = "optim"), data= m2.2006 )
#xm2.smooth = lmer(pred.m2 ~ meanPM+(1+ meanPM|aodid), data= m2.2006 )
#correlate to see everything from mod2 and the mpm works
...
#rerun the lme on the predictions including the spatial spline (smooth)
Final_pred_2006 <- lme(pred.t32 ~ meanPM ,random = list(aodid= ~1 + meanPM ),control=lmeControl(opt = "optim"),data= m2.2006  )
...
m3.fit.2006<- summary(lm(PM25~pred.m3,data=m1.2006))
res[res$year=="2006", 'm3.R2'] <- print(summary(lm(PM25~pred.m3,data=m1.2006))$r.squared)    
#RMSPE
...
mod3best[!is.na(pred.m1),bestpred := pred.m1]
#save
saveRDS(mod3best,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3best_2006.rds")
...
ggsave(file="/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/LTPM.2006.m3.png")
...
write.csv(mod3best[, list(LTPM = mean(bestpred, na.rm = T), 
                          ...
                          npred.m2 = sum(!is.na(pred.m2)),
                          npred.m3 = sum(!is.na(pred.m3)),
                          x_aod_ITM =  x_aod_ITM[1], y_aod_ITM = y_aod_ITM[1]),by=aodid], "/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/FINALLTPM.2006.csv", row.names = F)
...
## glance(lm(PM25~predicted,data=m1.2007))
## #get rid of missing
...
## m3.fit.2007<- summary(lm(PM25~pred.m3,data=m1.2007))
## res[res$year=="2007", 'm3.R2'] <- print(summary(lm(PM25~pred.m3,data=m1.2007))$r.squared)    
## #RMSPE
...
## ggsave(file="/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/LTPM.2007.m3.png")
...
##                           npred.m2 = sum(!is.na(pred.m2)),
##                           npred.m3 = sum(!is.na(pred.m3)),
##                           x_aod_ITM =  x_aod_ITM[1], y_aod_ITM = y_aod_ITM[1]),by=aodid], "/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/FINALLTPM.2007.csv", row.names = F)
...
glance(lm(PM25~predicted,data=m1.2008))
#get rid of missing
...
m2.2008<-m2.2008[!is.na(meanPM)]



#run the lmer part regressing stage 2 pred Vs mean pm
#in israel check per month, also check 30km band and other methods for meanpm
m2.smooth = lme(pred.m2 ~ meanPM,random = list(aodid= ~1 + meanPM),control=lmeControl(opt = "optim"), data= m2.2008 )
#xm2.smooth = lmer(pred.m2 ~ meanPM+(1+ meanPM|aodid), data= m2.2008 )
#correlate to see everything from mod2 and the mpm works
...
#rerun the lme on the predictions including the spatial spline (smooth)
Final_pred_2008 <- lme(pred.t32 ~ meanPM ,random = list(aodid= ~1 + meanPM ),control=lmeControl(opt = "optim"),data= m2.2008  )
...
m3.fit.2008<- summary(lm(PM25~pred.m3,data=m1.2008))
res[res$year=="2008", 'm3.R2'] <- print(summary(lm(PM25~pred.m3,data=m1.2008))$r.squared)    
#RMSPE
...
mod3best[!is.na(pred.m1),bestpred := pred.m1]
#save
saveRDS(mod3best,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3best_2008.rds")
...
ggsave(file="/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/LTPM.2008.m3.png")
...
write.csv(mod3best[, list(LTPM = mean(bestpred, na.rm = T), 
                          ...
                          npred.m2 = sum(!is.na(pred.m2)),
                          npred.m3 = sum(!is.na(pred.m3)),
                          x_aod_ITM =  x_aod_ITM[1], y_aod_ITM = y_aod_ITM[1]),by=aodid], "/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/FINALLTPM.2008.csv", row.names = F)
...
glance(lm(PM25~predicted,data=m1.2009))
#get rid of missing
...
m2.2009<-m2.2009[!is.na(meanPM)]



#run the lmer part regressing stage 2 pred Vs mean pm
#in israel check per month, also check 30km band and other methods for meanpm
m2.smooth = lme(pred.m2 ~ meanPM,random = list(aodid= ~1 + meanPM),control=lmeControl(opt = "optim"), data= m2.2009 )
#xm2.smooth = lmer(pred.m2 ~ meanPM+(1+ meanPM|aodid), data= m2.2009 )
#correlate to see everything from mod2 and the mpm works
...
#rerun the lme on the predictions including the spatial spline (smooth)
Final_pred_2009 <- lme(pred.t32 ~ meanPM ,random = list(aodid= ~1 + meanPM ),control=lmeControl(opt = "optim"),data= m2.2009  )
...
m3.fit.2009<- summary(lm(PM25~pred.m3,data=m1.2009))
res[res$year=="2009", 'm3.R2'] <- print(summary(lm(PM25~pred.m3,data=m1.2009))$r.squared)    
#RMSPE
...
mod3best[!is.na(pred.m1),bestpred := pred.m1]
#save
saveRDS(mod3best,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3best_2009.rds")
...
ggsave(file="/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/LTPM.2009.m3.png")
...
write.csv(mod3best[, list(LTPM = mean(bestpred, na.rm = T), 
                          ...
                          npred.m2 = sum(!is.na(pred.m2)),
                          npred.m3 = sum(!is.na(pred.m3)),
                          x_aod_ITM =  x_aod_ITM[1], y_aod_ITM = y_aod_ITM[1]),by=aodid], "/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/FINALLTPM.2009.csv", row.names = F)
...
glance(lm(PM25~predicted,data=m1.2010))
#get rid of missing
...
m2.2010<-m2.2010[!is.na(meanPM)]



#run the lmer part regressing stage 2 pred Vs mean pm
#in israel check per month, also check 30km band and other methods for meanpm
m2.smooth = lme(pred.m2 ~ meanPM,random = list(aodid= ~1 + meanPM),control=lmeControl(opt = "optim"), data= m2.2010 )
#xm2.smooth = lmer(pred.m2 ~ meanPM+(1+ meanPM|aodid), data= m2.2010 )
#correlate to see everything from mod2 and the mpm works
...
#rerun the lme on the predictions including the spatial spline (smooth)
Final_pred_2010 <- lme(pred.t32 ~ meanPM ,random = list(aodid= ~1 + meanPM ),control=lmeControl(opt = "optim"),data= m2.2010  )
...
mod3best[!is.na(pred.m1),bestpred := pred.m1]
#save
saveRDS(mod3best,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3best_2010.rds")
...
ggsave(file="/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/LTPM.2010.m3.png")
...
write.csv(mod3best[, list(LTPM = mean(bestpred, na.rm = T), 
                          ...
                          npred.m2 = sum(!is.na(pred.m2)),
                          npred.m3 = sum(!is.na(pred.m3)),
                          x_aod_ITM =  x_aod_ITM[1], y_aod_ITM = y_aod_ITM[1]),by=aodid], "/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/FINALLTPM.2010.csv", row.names = F)
...
glance(lm(PM25~predicted,data=m1.2011))
#get rid of missing
...
m2.2011<-m2.2011[!is.na(meanPM)]



#run the lmer part regressing stage 2 pred Vs mean pm
#in israel check per month, also check 30km band and other methods for meanpm
m2.smooth = lme(pred.m2 ~ meanPM,random = list(aodid= ~1 + meanPM),control=lmeControl(opt = "optim"), data= m2.2011 )
#xm2.smooth = lmer(pred.m2 ~ meanPM+(1+ meanPM|aodid), data= m2.2011 )
#correlate to see everything from mod2 and the mpm works
...
#rerun the lme on the predictions including the spatial spline (smooth)
Final_pred_2011 <- lme(pred.t32 ~ meanPM ,random = list(aodid= ~1 + meanPM ),control=lmeControl(opt = "optim"),data= m2.2011  )
...
m3.fit.2011<- summary(lm(PM25~pred.m3,data=m1.2011))
res[res$year=="2011", 'm3.R2'] <- print(summary(lm(PM25~pred.m3,data=m1.2011))$r.squared)    
#RMSPE
...
mod3best[!is.na(pred.m1),bestpred := pred.m1]
#save
saveRDS(mod3best,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3best_2011.rds")
...
ggsave(file="/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/LTPM.2011.m3.png")
...
write.csv(mod3best[, list(LTPM = mean(bestpred, na.rm = T), 
                          ...
                          npred.m2 = sum(!is.na(pred.m2)),
                          npred.m3 = sum(!is.na(pred.m3)),
                          x_aod_ITM =  x_aod_ITM[1], y_aod_ITM = y_aod_ITM[1]),by=aodid], "/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/FINALLTPM.2011.csv", row.names = F)
...
glance(lm(PM25~predicted,data=m1.2012))
#get rid of missing
...
m2.2012<-m2.2012[!is.na(meanPM)]



#run the lmer part regressing stage 2 pred Vs mean pm
#in israel check per month, also check 30km band and other methods for meanpm
m2.smooth = lme(pred.m2 ~ meanPM,random = list(aodid= ~1 + meanPM),control=lmeControl(opt = "optim"), data= m2.2012 )
#xm2.smooth = lmer(pred.m2 ~ meanPM+(1+ meanPM|aodid), data= m2.2012 )
#correlate to see everything from mod2 and the mpm works
...
#rerun the lme on the predictions including the spatial spline (smooth)
Final_pred_2012 <- lme(pred.t32 ~ meanPM ,random = list(aodid= ~1 + meanPM ),control=lmeControl(opt = "optim"),data= m2.2012  )
...
m3.fit.2012<- summary(lm(PM25~pred.m3,data=m1.2012))
res[res$year=="2012", 'm3.R2'] <- print(summary(lm(PM25~pred.m3,data=m1.2012))$r.squared)    
#RMSPE
...
mod3best[!is.na(pred.m1),bestpred := pred.m1]
#save
saveRDS(mod3best,"/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod3best_2012.rds")
...
ggsave(file="/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/LTPM.2012.m3.png")
...
write.csv(mod3best[, list(LTPM = mean(bestpred, na.rm = T), 
                          ...
                          npred.m2 = sum(!is.na(pred.m2)),
                          npred.m3 = sum(!is.na(pred.m3)),
                          x_aod_ITM =  x_aod_ITM[1], y_aod_ITM = y_aod_ITM[1]),by=aodid], "/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/FINALLTPM.2012.csv", row.names = F)
