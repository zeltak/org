...
# #get names order
# #l=seq(names(m2.2007));names(l)=names(m2.2007);l
# # m2.2007s<-m2.2007[,c(1,2,5,7,8,9,56),with=FALSE]
# #remove uneeded files and save
# #merge with mod2 predicted data to create mod2
# setkey(m2.2007s,day, aodid)
# setkey(mpmg,day, aodid)
# m2.2007 <- merge(m2.2007s, mpmg)
# names(m2.2007)
# m2.2007[,m:=NULL]
# m2.2007[,y_aod_ITM.y:=NULL]
# m2.2007[,x_aod_ITM.y:=NULL]
# setnames(m2.2007,"y_aod_ITM.x","y_aod_ITM")
# setnames(m2.2007,"x_aod_ITM.x","x_aod_ITM")
...
#Mod3
###############
mod1table<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod1table2007_p2.rds")
...
mod1table$r2007[21] <-summary(lm(m2.2007$pred.m2~m2.2007$pred.t31))$r.squared
...
m2.2007[, pred.t32 := predict(Final_pred_2007)]
#check correlations
mod3b_reg<-lm(m2.2007$pred.m2 ~m2.2007$pred.t32)
mod1table$r2007[22] <-summary(mod3b_reg)$r.squared
saveRDS(mod1table, "/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mod1table2007_p2.rds")

#############saving point
saveRDS(Final_pred_2007 , "/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/Final_pred_2007.rds")
saveRDS(fit2_1 , "/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/fit2_1_2007.rds")
saveRDS(fit2_2 , "/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/fit2_2_2007.rds")
saveRDS(fit2_3 , "/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/fit2_3_2007.rds")
saveRDS(fit2_4 , "/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/fit2_4_2007.rds")
saveRDS(fit2_5 , "/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/fit2_5_2007.rds")
saveRDS(fit2_6 , "/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/fit2_6_2007.rds")


#clean
keep(Final_pred_2007,mpmg,mod1table, sure=TRUE) 
gc()
...
mpmg.seT5$mixpred<-  predict(Final_pred_2007,mpmg.seT5)
mpmg<-rbind(mpmg.seT1,mpmg.seT2,mpmg.seT3,mpmg.seT4,mpmg.seT5)

saveRDS(mpmg, "/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/mpmg_Temp2007.rds")
rm(mpmg.seT1)
rm(mpmg.seT2)
rm(mpmg.seT3)
rm(mpmg.seT4)
...
# Final_pred_2007<- readRDS( "/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/Final_pred_2007.rds")
fit2_1<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/fit2_1_2007.rds")
fit2_2<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/fit2_2_2007.rds")
fit2_3<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/fit2_3_2007.rds")
fit2_4<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/fit2_4_2007.rds")
fit2_5<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/fit2_5_2007.rds")
fit2_6<-readRDS("/media/NAS/Uni/Projects/P046_Israel_MAIAC/3.Work/2.Gather_data/FN000_RWORKDIR/fit2_6_2007.rds")
