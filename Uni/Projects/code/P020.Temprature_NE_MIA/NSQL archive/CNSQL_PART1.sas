...
data mods.Mod2_2000_pred;
 set Mod2_2000_v4;
  pred = fix_intercept + Ntckin*fix_mit  + elev*fix_elev + purban*fix_purban + NDVI*fix_NDVI + OVR_int + Ntckin*OVR_mit;
run;
...
proc summary nway data=lst2001prew;
class glong glat;
var Rid Rin ;
...
proc sql;
  create table DATA3  as
   select *
    from lst2001prew left join sum_Ri
     on lst2001prew.glong = sum_Ri.glong and  lst2001prew.glat = sum_Ri.glat ;
run;
...
class date ;
   model tempc = mit elev purban NDVI / s outpred=pdataA_2001;
...
proc summary nway data=lst2002prew;
class glong glat;
var Rid Rin ;
output out=sum_Ri mean=Rid_s Rin_s;
run;
...
proc sql;
  create table DATA3  as
   select *
    from lst2002prew left join sum_Ri
     on lst2002prew.glong = sum_Ri.glong and  lst2002prew.glat = sum_Ri.glat ;
run;
...
class date ;
   model tempc = mit elev purban NDVI / s outpred=pdataA_2002;
    random int mit/ sub = date s ;
...
proc summary nway data=lst2004prew;
class glong glat;
var Rid Rin ;
output out=sum_Ri mean=Rid_s Rin_s;
run;
...
proc sql;
  create table DATA3  as
   select *
    from lst2004prew left join sum_Ri
     on lst2004prew.glong = sum_Ri.glong and  lst2004prew.glat = sum_Ri.glat ;
run;
...
class date ;
   model tempc = mit elev purban NDVI / s outpred=pdataA_2004;
    random int mit/ sub = date s ;
...
proc summary nway data=lst2005prew;
class glong glat;
var Rid Rin ;
output out=sum_Ri mean=Rid_s Rin_s;
run;
...
proc sql;
  create table DATA3  as
   select *
    from lst2005prew left join sum_Ri
     on lst2005prew.glong = sum_Ri.glong and  lst2005prew.glat = sum_Ri.glat ;
run;
...
class date ;
   model tempc = mit elev purban NDVI / s outpred=pdataA_2005;
    random int mit/ sub = date s ;
...
proc summary nway data=lst2006prew;
class glong glat;
var Rid Rin ;
output out=sum_Ri mean=Rid_s Rin_s;
run;
...
proc sql;
  create table DATA3  as
   select *
    from lst2006prew left join sum_Ri
     on lst2006prew.glong = sum_Ri.glong and  lst2006prew.glat = sum_Ri.glat ;
run;
...
class date ;
   model tempc = mit elev purban NDVI / s outpred=pdataA_2006;
    random int mit/ sub = date s ;
...
proc summary nway data=lst2007prew;
class glong glat;
var Rid Rin ;
output out=sum_Ri mean=Rid_s Rin_s;
run;
...
proc sql;
  create table DATA3  as
   select *
    from lst2007prew left join sum_Ri
     on lst2007prew.glong = sum_Ri.glong and  lst2007prew.glat = sum_Ri.glat ;
run;
...
class date ;
   model tempc = mit elev purban NDVI / s outpred=pdataA_2007;
    random int mit/ sub = date s ;
...
proc summary nway data=lst2008prew;
class glong glat;
var Rid Rin ;
output out=sum_Ri mean=Rid_s Rin_s;
run;
...
proc sql;
  create table DATA3  as
   select *
    from lst2008prew left join sum_Ri
     on lst2008prew.glong = sum_Ri.glong and  lst2008prew.glat = sum_Ri.glat ;
run;
...
class date ;
   model tempc = mit elev purban NDVI / s outpred=pdataA_2008;
    random int mit/ sub = date s ;
...
proc summary nway data=lst2009prew;
class glong glat;
var Rid Rin ;
output out=sum_Ri mean=Rid_s Rin_s;
run;
...
proc sql;
  create table DATA3  as
   select *
    from lst2009prew left join sum_Ri
     on lst2009prew.glong = sum_Ri.glong and  lst2009prew.glat = sum_Ri.glat ;
run;
...
class date ;
   model tempc = mit elev purban NDVI / s outpred=pdataA_2009;
    random int mit/ sub = date s ;
...
proc summary nway data=lst2010prew;
class glong glat;
var Rid Rin ;
output out=sum_Ri mean=Rid_s Rin_s;
run;
...
proc sql;
  create table DATA3  as
   select *
    from lst2010prew left join sum_Ri
     on lst2010prew.glong = sum_Ri.glong and  lst2010prew.glat = sum_Ri.glat ;
run;
...
class date ;
   model tempc = mit elev purban NDVI / s outpred=pdataA_2010;
    random int mit/ sub = date s ;
...
proc summary nway data=lst2011prew;
class glong glat;
var Rid Rin ;
output out=sum_Ri mean=Rid_s Rin_s;
run;
...
proc sql;
  create table DATA3  as
   select *
    from lst2011prew left join sum_Ri
     on lst2011prew.glong = sum_Ri.glong and  lst2011prew.glat = sum_Ri.glat ;
run;
...
class date ;
   model tempc = mit elev purban NDVI / s outpred=pdataA_2011;
    random int mit/ sub = date s ;
