...
#------------------------>>>
#import mod3 
data.m3 <- readRDS("/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/Xmod3.AQ.rds")
...
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/mod3.AQ.PM25.2008.pred3.rds")
...
#recode negative into zero
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/mod3.AQ.PM25.2004.pred3.rds")
...
saveRDS(mod3,"/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/mod3.AQ.PM25.2005.pred3.rds")
#clean
keep(m2.all,data.m3,mod3,res,rmse, sure=TRUE) 
gc()
#2006
...
#recode negative into zero
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/mod3.AQ.PM25.2006.pred3.rds")
...
#recode negative into zero
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/mod3.AQ.PM25.2007.pred3.rds")
...
#recode negative into zero
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/mod3.AQ.PM25.2009.pred3.rds")
...
#recode negative into zero
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/mod3.AQ.PM25.2010.pred3.rds")
...
#recode negative into zero
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/mod3.AQ.PM25.2011.pred3.rds")
...
#recode negative into zero
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/mod3.AQ.PM25.2012.pred3.rds")
...
#recode negative into zero
#mod3 <- mod3[pred.m3 >= 0]
saveRDS(mod3,"/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/mod3.AQ.PM25.2013.pred3.rds")
...
data.m3.2008<-readRDS("/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/mod3.AQ.PM25.2008.pred3.rds")
data.m3.2004<-readRDS("/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/mod3.AQ.PM25.2004.pred3.rds")
data.m3.2005<-readRDS("/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/mod3.AQ.PM25.2005.pred3.rds")
data.m3.2006<-readRDS("/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/mod3.AQ.PM25.2006.pred3.rds")
data.m3.2007<-readRDS("/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/mod3.AQ.PM25.2007.pred3.rds")
data.m3.2008<-readRDS("/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/mod3.AQ.PM25.2008.pred3.rds")
data.m3.2009<-readRDS("/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/mod3.AQ.PM25.2009.pred3.rds")
data.m3.2010<-readRDS("/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/mod3.AQ.PM25.2010.pred3.rds")
data.m3.2011<-readRDS("/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/mod3.AQ.PM25.2011.pred3.rds")
data.m3.2012<-readRDS("/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/mod3.AQ.PM25.2012.pred3.rds")
data.m3.2013<-readRDS("/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/mod3.AQ.PM25.2013.pred3.rds")
mod3<-rbindlist(list(data.m3.2008,data.m3.2004,data.m3.2005,data.m3.2006,data.m3.2007,data.m3.2008,data.m3.2009,data.m3.2010,data.m3.2011,data.m3.2012,data.m3.2013))
...
#########################
#load mod1
m1.all <-readRDS("/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/Xmod1C.AQ.PM25.pred.rds")
m1.all[,aodid:= paste(m1.all$long_aod.x,m1.all$lat_aod.x,sep="-")]
m1.all<-m1.all[,c("aodid","day","PM25","pred.m1","SiteCode","c"),with=FALSE]
#R2.m3
...
saveRDS(res, "/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/resALL.AQ.PM25.rds")

#########################
#import mod2
mod2<- readRDS( "/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/Xmod2.AQ.PM25.pred.rds")
...
#save
saveRDS(mod3best,"/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/Xmod3.AQ.PM25.bestpred.rds")
...
write.csv(mod3best[, list(LTPM = mean(bestpred, na.rm = T), 
                          ...
                          x_aod_ITM =  x_aod_ITM[1], y_aod_ITM = y_aod_ITM[1]),by=aodid], "/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/Xmod3.AQ.PM25.LTPM.csv", row.names = F)

#export res to csv

write.csv(res,"/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/m3rds/resALL.AQ.PM25.csv")
...
# rmse by monitor
neveruse <- c("")
m1.all[!SiteCode %in% neveruse, list(rmse = sqrt(mean((pred.m3 - PM25)^2))),by=c("SiteCode", "c")][order(rmse)]

#alt method
rmse.p25 <- ddply(m1.all, c("SiteCode"), 
      function(x) {
...
out<-m1.all[c==2008] %>%
  group_by(SiteCode) %>%
  summarise (n = n()) 
setkey(out,SiteCode,c)
head(out,n=550)



# plot a single year by day- KMR- North
ggplot(m1.all[SiteCode %in% c("KMR") & c == 2008,], aes(x = day)) + 
#overall line
...
ggplot(m1.all[SiteCode %in% c("TIV") & c == 2008,], aes(x = day)) + 
#overall line
  geom_line(aes(y = PM25), color = "black", alpha = 0.15) + 
  #points
  geom_point(aes(y = PM25), color = "blue", alpha = 0.7, size = 0.8) + 
...
ggplot(m1.all[SiteCode %in% c("SYO") & c == 2008,], aes(x = day)) + 
#overall line
  geom_line(aes(y = PM25), color = "black", alpha = 0.15) + 
  #points
  geom_point(aes(y = PM25), color = "blue", alpha = 0.7, size = 0.8) + 
...
ggplot(m1.all[SiteCode %in% c("GDR") & c == 2008,], aes(x = day)) + 
#overall line
  geom_line(aes(y = PM25), color = "black", alpha = 0.15) + 
  #points
  geom_point(aes(y = PM25), color = "blue", alpha = 0.7, size = 0.8) + 
