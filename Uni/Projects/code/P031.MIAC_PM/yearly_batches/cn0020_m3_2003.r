...
Final_pred_2003  = lme(newpred ~ meanPMmean ,random = list(guid= ~1 + meanPMmean ),control=lmeControl(opt = "optim"),data= m2mpm  )
...
saveRDS(mod3,"/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/FN008_model_prep/m3_2003.pred3_NM.rds")
#clean
keep(mod3, sure=TRUE) 
gc()
...
#save
saveRDS(mod3best,"/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/FN008_model_prep/mod3best_2003NM.rds")
...
write.csv(mod3best[, list(LTPM = mean(bestpred, na.rm = T), 
                          ...
                          long_aod =  long_aod[1], lat_aod = lat_aod[1]),by=guid], "/media/NAS/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/FN000_RWORKDIR/pestpred2003LPM_NM.csv", row.names = F)
