...
loc<-fread("/home/zeltak/smb4k/ZUNISYN/ZUraid/Uni/Projects/P011.BirthW_NE/3.1.11.4.Work/3.Analysis/2.R_analysis/bw_diab37.csv")
...
"cig_preg", "cig_pre", "med_income", "p_ospace", "gender","adtmean", "prev_400","diab",  "hyper" ,"lungd", "diab_other", "prevpret",
"edu_group","MRN","ges_calc","uniqueid_y"                
                                  ),with=FALSE]
