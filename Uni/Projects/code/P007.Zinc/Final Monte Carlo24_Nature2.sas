...
merge faofbs_t(in=a) ZnN.Ran_PFS_WR_&i(in=b);
  by ItemCode1;
    if a;
run; 
...
merge ZnN.Results_PFS_WR_&i(in=a) znpymis (in=b)  ;
  by ItemCode1;
    if a;
	run; 
...
merge faofbs_t(in=a) ZnN.Ran_PFS_NR_&i(in=b);
  by ItemCode1;
    if a;
run; 
...
merge ZnN.Results_PFS_NR_&i(in=a) znpymis (in=b)  ;
  by ItemCode1;
    if a;
	run; 
...
proc append base=work.Final_PFS_WR data=ZnN.faofbs_PFS_WR_krw_&i; run;

proc append base=work.Final_PFS_NR data=ZnN.faofbs_PFS_NR_krw_&i; run;
...
class country_code name_of_former_variable_1;
 var mgZn_100kcal;
  output out = work.out1_PFS_WR(keep = itemcode1 country_code name_of_former_variable_1 P_2_5 P_50 P_97_5) pctlpre=P_ pctlpts= 0 to 100 by 2.5;
   by itemcode1;
run;

data work.out1_PFS_WR_zn(drop = P_2_5 P_50 P_97_5);
 set work.out1_PFS_WR; 
  P_2_5_zn  = P_2_5;
  P_50_zn   = P_50; 
  P_97_5_zn = P_97_5;
run;
...
class country_code name_of_former_variable_1;
 var mgZn_100kcal;
  output out = work.out1_PFS_NR(keep = itemcode1 country_code name_of_former_variable_1 P_2_5 P_50 P_97_5) pctlpre=P_ pctlpts= 0 to 100 by 2.5;
   by itemcode1;
run;

data work.out1_PFS_NR_zn(drop = P_2_5 P_50 P_97_5);
 set work.out1_PFS_NR; 
  P_2_5_zn  = P_2_5;
  P_50_zn   = P_50; 
  P_97_5_zn = P_97_5;
run;
