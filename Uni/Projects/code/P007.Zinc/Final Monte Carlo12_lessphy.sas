...
/*** Phy Mod 1 ***/ *run again or use same mod1 generated above, we deleted it, so this needs to either remain in or be regenerated;
...
data zn2.Ran_Mod_15_&i;
merge zn2.model_1_&i(in=a) zn2.model_5_&i(in=b);
  by ItemCode1;
run;  

data zn2.Ran_Mod_15_&i(rename = (kcalrcphy_rg3m = kcalrcphy_sumg3m));
set zn2.Ran_Mod_15_&i;
 run;


proc datasets lib = ZN;   delete model_1_&i model_5_&i; run; 
...
/** Phy  Mod 3***/ *run again or use same mod3 generated above, we deleted it, so this needs to either remain in or be regenerated;
...
data zn2.Ran_Mod_36_&i;
merge zn2.model_3_&i(in=a) zn2.model_6_&i(in=b);
  by ItemCode1;
run;  

data zn2.Ran_Mod_36_&i(rename = (kcalrcphy_rg4m = kcalrcphy_sumg4m));
set zn2.Ran_Mod_36_&i;
 run;


proc datasets lib = ZN2;   delete model_63_&i model_6_&i; run; 
...
proc sort data = faofbs_t;           by ItemCode1 ;run;
proc sort data = zn2.Ran_mod_15_&i;   by ItemCode1 ;run;

data zn2.Results_Mod15_&i(drop=kcalrczn kcalrcphyt);
merge faofbs_t(in=a) zn2.Ran_mod_15_&i(in=b);
  by ItemCode1;
    if a;
run; 


proc sort data = zn2.Results_Mod15_&i; by ItemCode1   ;run;
proc sort data = znpymis ; by ItemCode1 ;run;

data zn2.Results_Mod15_&i;
merge zn2.Results_Mod15_&i(in=a) znpymis (in=b)  ;
  by ItemCode1;
    if a;
	run; 
...
proc sort data = faofbs_t;          by ItemCode1 ;run;
proc sort data = zn2.Ran_mod_36_&i;   by ItemCode1 ;run;

data zn2.Results_Mod36_&i(drop=kcalrczn kcalrcphyt);
merge faofbs_t(in=a) zn2.Ran_mod_36_&i(in=b);
  by ItemCode1;
    if a;
run; 

proc sort data = zn2.Results_Mod36_&i; by ItemCode1   ;run;
proc sort data = znpymis ; by ItemCode1 ;run;

data zn2.Results_Mod36_&i;
merge zn2.Results_Mod36_&i(in=a) znpymis (in=b)  ;
  by ItemCode1;
    if a;
	run; 
...
proc append base=zn2.Final_Mod_15 data=zn2.Faofbs_m5_krw_&i;
run;

proc append base=zn2.Final_Mod_36 data=zn2.Faofbs_m6_krw_&i;
run;
...
**********************************Model 15****************************************************************;
proc sort data = zn2.Final_Mod_15; by itemcode1; run;

proc univariate data = zn2.Final_Mod_15;
class country_code name_of_former_variable_1;
 var mgZn_100kcal;
  output out = out1_Mod_15(keep = itemcode1 country_code name_of_former_variable_1 P_2_5 P_50 P_97_5) pctlpre=P_ pctlpts= 0 to 100 by 2.5;
   by itemcode1;
run;

data out1_Mod_15_zn(drop = P_2_5 P_50 P_97_5);
 set out1_Mod_15; 
  P_2_5_zn  = P_2_5;
  P_50_zn   = P_50; 
  P_97_5_zn = P_97_5;
...
data out1_Mod_15_phy(drop = P_2_5 P_50 P_97_5);
 set out1_Mod_15; 
  P_2_5_phy   = P_2_5;
  P_50_phy    = P_50; 
  P_97_5_phy  = P_97_5;
...
proc sort data = out1_Mod_15_phy; by country_code name_of_former_variable_1 itemcode1 ;run;
proc sort data = out1_Mod_15_zn ; by country_code name_of_former_variable_1 itemcode1 ;run;

data Out1_Final_Mod15;
merge out1_Mod_15_zn(in=a) out1_Mod_15_phy (in=b)  ;
  by   country_code name_of_former_variable_1 itemcode1;
run;


data Variable(drop = iteration -- mgPhyt_100kcal);
 set zn2.Final_Mod_15;
  if iteration = 1;
run;


proc sort data = Variable;         by country_code name_of_former_variable_1 itemcode1 ;run;
proc sort data = Out1_Final_Mod15; by country_code name_of_former_variable_1 itemcode1 ;run;

data Out1_Final_Mod15;
merge Variable(in=a) Out1_Final_Mod15 (in=b)  ;
  by   country_code name_of_former_variable_1 itemcode1;
run;
...
data zn2.faofbs_krwdef_Mod15;
set  work.faofbs_krwdef;
run; 



proc sort data = zn2.Final_Mod_16; by itemcode1; run;

proc univariate data = zn2.Final_Mod_16;
class country_code name_of_former_variable_1;
 var mgZn_100kcal;
  output out = out1_Mod_16(keep = itemcode1 country_code name_of_former_variable_1 P_2_5 P_50 P_97_5) pctlpre=P_ pctlpts= 0 to 100 by 2.5;
   by itemcode1;
run;

data out1_Mod_16_zn(drop = P_2_5 P_50 P_97_5);
 set out1_Mod_16; 
  P_2_5_zn  = P_2_5;
  P_50_zn   = P_50; 
  P_97_5_zn = P_97_5;
...
data out1_Mod_16_phy(drop = P_2_5 P_50 P_97_5);
 set out1_Mod_16; 
  P_2_5_phy   = P_2_5;
  P_50_phy    = P_50; 
  P_97_5_phy  = P_97_5;
...
proc sort data = out1_Mod_16_phy; by country_code name_of_former_variable_1 itemcode1 ;run;
proc sort data = out1_Mod_16_zn ; by country_code name_of_former_variable_1 itemcode1 ;run;

data Out1_Final_Mod16;
merge out1_Mod_16_zn(in=a) out1_Mod_16_phy (in=b)  ;
  by   country_code name_of_former_variable_1 itemcode1;
run;


data Variable(drop = iteration -- mgPhyt_100kcal);
 set zn2.Final_Mod_16;
  if iteration = 1;
run;


proc sort data = Variable;         by country_code name_of_former_variable_1 itemcode1 ;run;
proc sort data = Out1_Final_Mod16; by country_code name_of_former_variable_1 itemcode1 ;run;

data Out1_Final_Mod16;
merge Variable(in=a) Out1_Final_Mod16 (in=b)  ;
  by   country_code name_of_former_variable_1 itemcode1;
run;
