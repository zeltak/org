...
*Total of 3 models;
*Contains 2 models: E3 data (with IZiNCG physiological requirements) and without rice (IZiNCG and IOM Physiological zinc
...
class country_code name_of_former_variable_1;
 var mgZn_100kcal;
  output out = ZnN.out1_PFS_WR(keep = itemcode1 country_code name_of_former_variable_1 P_2_5 P_50 P_97_5) pctlpre=P_ pctlpts= 0 to 100 by 2.5;
   by itemcode1;
run;
...
data ZnN.faofbs_krw (rename =(name_of_former_variable_1 = year));
 set ZnN.faofbs_krw ;
run; 

proc sort data=ZnN.faofbs_krw;
by continent_code continent region_code region country_code country iso_code
   itemcode1 itemcodeB itemcode;
run; 

proc summary data=ZnN.faofbs_krw;
...
output out=Znn.faofbs_krw2005a mean = ;
...
proc sort data=ZnN.faofbs_krw2005a;
by continent_code continent region_code region country_code country iso_code  ;
run;

*Transpose data ;
proc transpose data=ZnN.faofbs_krw2005a out = ZnN.faofbs_krw2005;
by continent_code continent region_code region country_code country iso_code ;
id itemcode1;
...
data ZnN.faofbs_krw2005;
set ZnN.faofbs_krw2005;
calc_tot = SUM (OF _25112 -- _25202);
run;

proc sort data=ZnN.faofbs_krw2005;
by continent_code continent region_code region country_code country iso_code  ;
run;

proc transpose data=ZnN.faofbs_krw2005 out = ZnN.faofbs_krwyear;
by continent_code continent region_code region country_code country iso_code ;
id _name_;
var calc_tot;
run;
...
proc sort data=ZnN.faofbs_krwyear;
by country_code ;
run;
...
data ZnN.faofbs_krwyear (rename = (_name_ = nut_cap_d));
merge ZnN.faofbs_krwyear ZnN.wpp2010_b (keep = country_code pop_tot1000 );
by country_code ;
run;
...
data ZnN.faofbs_krwyear;
merge ZnN.faofbs_krwyear ZnN.wpp2010_znreq (keep=continent_code continent region_code region country_code country iso_code 
PrZn_mean);
by continent_code continent region_code region country_code country iso_code ;
run;
...
class country_code name_of_former_variable_1;
 var mgZn_100kcal;
  output out = ZnN.out1_PFS_NR(keep = itemcode1 country_code name_of_former_variable_1 P_2_5 P_50 P_97_5) pctlpre=P_ pctlpts= 0 to 100 by 2.5;
   by itemcode1;
run;
