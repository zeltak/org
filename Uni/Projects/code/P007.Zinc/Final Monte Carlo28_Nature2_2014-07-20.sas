...
/*libname work 'Z:\Uni\Projects\P007.Zinc\3.1.7.4.Work\2.Gather_data\NATURE DATA\Files\' ;
OPTIONS nofmterr;
...
/*libname ZnN "C:\Users\Ryan\Dropbox\P007.Zinc\3.1.7.4.Work\2.Gather_data\NATURE DATA\SASlib\" ;
/*OPTIONS nofmterr;*/

PROC IMPORT OUT= work.Final_Study_N
  DATAFILE= "C:\Users\Ryan\Dropbox\P007.Zinc\3.1.7.4.Work\2.Gather_data\NATURE DATA\Final_Study_1_nature.xlsx"
    DBMS=xlsx REPLACE;
	sheet = SAS_finalstudy;
	  GETNAMES=YES;
			RUN;
