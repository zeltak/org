...
proc printto log="P:\Projects\3.1.7.Zinc\3.1.7.5.Results\SAS\filename.log"; run;


libname zn 'P:\Projects\3.1.7.Zinc\3.1.7.5.Results\SAS\' ;

PROC IMPORT OUT= WORK.zinc
            DATAFILE= "P:\Projects\3.1.7.Zinc\3.1.7.4.Work\2.Gather_data\export to SAS\zinc.dbf" 
			            DBMS=DBF   REPLACE;
						     GETDELETED=NO;
							 RUN; 
...
PROC IMPORT OUT= WORK.zincsum
            DATAFILE= "P:\Projects\3.1.7.Zinc\3.1.7.4.Work\2.Gather_data\export to SAS\zincsum.dbf" 
			            DBMS=DBF   REPLACE;
						     GETDELETED=NO;
							 RUN; 
...
proc import datafile = 'P:\Projects\3.1.7.Zinc\3.1.7.4.Work\2.Gather_data\Myers CO2 UCDavis HSPH\FAOFBS_T_121004.dta'
 OUT= faofbs_t
  dbms = stata REPLACE;
run;
...
PROC IMPORT OUT= znpymis
  DATAFILE= "P:\Projects\3.1.7.Zinc\3.1.7.4.Work\2.Gather_data\sup.data\zn_phy_missing.csv" 
    DBMS=CSV REPLACE;
	  GETNAMES=YES;
	    DATAROW=2; 
		RUN;
...
proc import datafile = 'P:\Projects\3.1.7.Zinc\3.1.7.4.Work\2.Gather_data\Myers CO2 UCDavis HSPH\summ_ic_kcal.xls' 
 OUT = krw_nutrient
 dbms = xls REPLACE;
  sheet = krw_nutrient;
run;
       
proc import datafile = 'P:\Projects\3.1.7.Zinc\3.1.7.4.Work\2.Gather_data\Myers CO2 UCDavis HSPH\FAOFBS_wpp2010.xls'
 OUT= wpp2010_b
  dbms = xls REPLACE;
   sheet = wpp2010_b;
run;
