...
data zn2.Model_1_&i(drop = Model_2--Model_8);
...
data zn2.Model_2_&i(drop = Model_1 Model_3--Model_8);
 merge zn2.Crop_Name (in=a) zn2.Final_study_1_&i(in=b);
  by Model_2;
   if a and b;
run;
...
data zn2.Model_3_&i(drop = Model_1--Model_2 Model_4--Model_8);
 merge zn2.Crop_Name (in=a) zn2.Final_study_1_&i(in=b);
  by Model_3;
   if a and b;
run;
...
data zn2.Model_4_&i(drop = Model_1--Model_3 Model_5--Model_8);
 merge zn2.Crop_Name (in=a) zn2.Final_study_1_&i(in=b);
  by Model_4;
   if a and b;
run;
...
data zn2.Model_5_&i(drop = Model_1--Model_4 Model_6--Model_8);
 merge zn2.Crop_Name (in=a) zn2.Final_study_1_&i(in=b);
  by Model_5;
   if a and b;
run;
...
data zn2.Model_7_&i(drop = Model_1--Model_6 Model_8);
 merge zn2.Crop_Name (in=a) zn2.Final_study_1_&i(in=b);
  by model_7;
   if a and b;
run;
...
proc datasets lib = zn2; delete Faofbs_g3_krw_&i Faofbs_g4_krw_&i Faofbs_s3_krw_&i Faofbs_s4_krw_&i ;
...
**************This is for model 75, where is this for Model 12 and Model 34?;
**********************************Model 75****************************************************************;
