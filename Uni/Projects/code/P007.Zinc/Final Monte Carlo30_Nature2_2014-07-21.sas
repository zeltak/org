...
PROC IMPORT OUT= ZnN.Final_Study_N
...
data ZnN.Final_Study_N;
set ZnN.Final_Study_N;
run;
...
****Changed xls document name to faren_coded_2_nature to reflect update post Nature manuscript;
PROC IMPORT OUT= ZnN.Crop_Name
  DATAFILE= "Z:\Uni\Projects\P007.Zinc\3.1.7.4.Work\2.Gather_data\NATURE DATA\faren_coded_2_nature.xls" 
    DBMS=xls REPLACE;
	sheet = crop_name_nature;
	  GETNAMES=YES;
			RUN;
...
proc sort data = ZnN.Final_Study_N_&i; by Zn_PFS_WR; run;
proc sort data = ZnN.Crop_Name;        by Zn_PFS_WR; run;

data ZnN.Zn_PFS_WR_&i(drop = Zn_Prim_WR--Zn_PF_NR Zn_PFS_NR--Phy_PFS_NRFV);
 merge ZnN.Crop_Name (in=a) ZnN.Final_Study_N_&i(in=b);
  by Zn_PFS_WR;
   if a and b;
run;

data ZnN.Zn_PFS_WR_&i;
 set ZnN.Zn_PFS_WR_&i;
  count = _n_ ;
run;

/*** Model Zn_PFS_NR***/

proc sort data = ZnN.Final_Study_N_&i; by Zn_PFS_NR; run;
proc sort data = ZnN.Crop_Name;        by Zn_PFS_NR; run;

data ZnN.Zn_PFS_NR_&i(drop = Zn_Prim_WR--Zn_PFS_WR Zn_PFS_NRFV--Phy_PFS_NRFV);
 merge ZnN.Crop_Name (in=a) ZnN.Final_Study_N_&i(in=b);
  by Zn_PFS_NR;
   if a and b;
run;

data ZnN.Zn_PFS_NR_&i;
 set ZnN.Zn_PFS_NR_&i;
  count = _n_ ;
run;

/*** Model Phy_PFS_WR***/

proc sort data = ZnN.Final_Study_N_&i; by Phy_PFS_WR; run;
proc sort data = ZnN.Crop_Name;        by Phy_PFS_WR; run;

data ZnN.Phy_PFS_WR_&i(drop = Zn_Prim_WR--Phy_PF_NR Phy_PFS_NR--Phy_PFS_NRFV);
 merge ZnN.Crop_Name (in=a) ZnN.Final_Study_N_&i(in=b);
  by Phy_PFS_WR;
   if a and b;
run;

data ZnN.Phy_PFS_WR_&i;
 set ZnN.Phy_PFS_WR_&i;
  count = _n_ ;
run;

/*** Model Phy_PFS_NR***/

proc sort data = ZnN.Final_Study_N_&i; by Phy_PFS_NR; run;
proc sort data = ZnN.Crop_Name;        by Phy_PFS_NR; run;

data ZnN.Phy_PFS_NR_&i(drop = Zn_Prim_WR--Phy_PFS_WR Phy_PFS_NRFV);
 merge ZnN.Crop_Name (in=a) ZnN.Final_Study_N_&i(in=b);
  by Phy_PFS_NR;
   if a and b;
run;

data ZnN.Phy_PFS_NR_&i;
 set ZnN.Phy_PFS_NR_&i;
  count = _n_ ;
run;


proc datasets lib = ZnN;
...
data ZnN.Zn_PFS_WR_&i(keep = ItemCode1 Item kcalrczn kcalrcphyt PFS_WR_Zn_Pct kcalrczn_PFS_WR);
 set ZnN.Zn_PFS_WR_&i;
...
data ZnN.Phy_PFS_WR_&i(keep = ItemCode1 Item kcalrczn kcalrcphyt PFS_WR_Phy_Pct kcalrcphy_PFS_WR);
 set ZnN.Phy_PFS_WR_&i;
...
/*Merge*/
proc sort data = ZnN.Zn_PFS_WR_&i; by ItemCode1 ;run;
proc sort data = ZnN.Phy_PFS_WR_&i; by ItemCode1 ;run;

data ZnN.Ran_PFS_WR_&i;
merge ZnN.Zn_PFS_WR_&i(in=a) ZnN.Phy_PFS_WR_&i(in=b);
  by ItemCode1;
run;  

proc datasets lib = ZnN;   delete Zn_PFS_WR_&i Phy_PFS_WR_&i; run; 
...
data ZnN.Zn_PFS_NR_&i(keep = ItemCode1 Item kcalrczn kcalrcphyt PFS_NR_Zn_Pct kcalrczn_PFS_NR);
 set ZnN.Zn_PFS_NR_&i;
...
data ZnN.Phy_PFS_NR_&i(keep = ItemCode1 Item kcalrczn kcalrcphyt PFS_NR_Phy_Pct kcalrcphy_PFS_NR);
 set ZnN.Phy_PFS_NR_&i;
...
/*Merge*/
proc sort data = ZnN.Zn_PFS_NR_&i; by ItemCode1 ;run;
proc sort data = ZnN.Phy_PFS_NR_&i; by ItemCode1 ;run;

data ZnN.Ran_PFS_NR_&i;
merge ZnN.Zn_PFS_NR_&i(in=a) ZnN.Phy_PFS_NR_&i(in=b);
  by ItemCode1;
run;  

proc datasets lib = ZnN;   delete Zn_PFS_NR_&i Phy_PFS_NR_&i; run; 
...
proc import datafile = "Z:\Uni\Projects\P007.Zinc\3.1.7.4.Work\2.Gather_data\NATURE DATA\FAOFBS_T_121004.dta"
 OUT= ZnN.faofbs_t
  dbms = stata REPLACE;
run;
...
proc sort data = ZnN.faofbs_t; by ItemCode1  ;run; 



	
/*PROC IMPORT OUT= ZnN.znpymis
  DATAFILE= "G:\Dropbox\Myers CO2 UCDavis HSPH\3.1.7.4.Work\2.Gather_data\NATURE DATA\zn_phy_missing.csv" 
    DBMS=CSV REPLACE;
	  GETNAMES=YES;
		...
		PROC IMPORT OUT= ZnN.znpymis
  DATAFILE= "Z:\Uni\Projects\P007.Zinc\3.1.7.4.Work\2.Gather_data\NATURE DATA\zn_phy_missing.csv" 
    DBMS=CSV REPLACE;
	  GETNAMES=YES;
	    DATAROW=2; 
		RUN;
...
***Results of PFS_WR;
proc sort data = ZnN.faofbs_t;           by ItemCode1 ;run;
proc sort data = ZnN.Ran_PFS_WR_&i;   by ItemCode1 ;run;

data ZnN.Results_PFS_WR_&i(drop=kcalrczn kcalrcphyt);
merge ZnN.faofbs_t(in=a) ZnN.Ran_PFS_WR_&i(in=b);
  by ItemCode1;
    if a;
run; 


proc sort data = ZnN.Results_PFS_WR_&i; by ItemCode1   ;run;
proc sort data = ZnN.znpymis ; by ItemCode1 ;run;

data ZnN.Results_PFS_WR_&i;
merge ZnN.Results_PFS_WR_&i(in=a) ZnN.znpymis (in=b)  ;
  by ItemCode1;
    if a;
	run; 
...
***Results of PFS_NR;
proc sort data = ZnN.faofbs_t;           by ItemCode1 ;run;
proc sort data = ZnN.Ran_PFS_NR_&i;   by ItemCode1 ;run;

data ZnN.Results_PFS_NR_&i(drop=kcalrczn kcalrcphyt);
merge ZnN.faofbs_t(in=a) ZnN.Ran_PFS_NR_&i(in=b);
  by ItemCode1;
    if a;
run; 


proc sort data = ZnN.Results_PFS_NR_&i; by ItemCode1   ;run;
proc sort data = ZnN.znpymis ; by ItemCode1 ;run;

data ZnN.Results_PFS_NR_&i;
merge ZnN.Results_PFS_NR_&i(in=a) ZnN.znpymis (in=b)  ;
  by ItemCode1;
    if a;
	run; 
...
proc append base=ZnN.Final_PFS_WR data=ZnN.faofbs_PFS_WR_krw_&i; run;

proc append base=ZnN.Final_PFS_NR data=ZnN.faofbs_PFS_NR_krw_&i; run;


proc datasets lib = ZnN; delete faofbs_PFS_WR_krw_&i faofbs_PFS_NR_krw_&i ; 
run; 
...
proc import datafile = "Z:\Uni\Projects\P007.Zinc\3.1.7.4.Work\2.Gather_data\NATURE DATA\summ_ic_kcal.xls"
 OUT = ZnN.krw_nutrient
 dbms = xls REPLACE;
  sheet = krw_nutrient;
run;
       
proc import datafile = "Z:\Uni\Projects\P007.Zinc\3.1.7.4.Work\2.Gather_data\NATURE DATA\FAOFBS_wpp2010.xlsx"
 OUT= ZnN.wpp2010_b
  dbms = xlsx REPLACE;
   sheet = wpp2010_b;
run;
...
proc sort data = ZnN.Final_PFS_WR; by itemcode1; run;

proc univariate data = ZnN.Final_PFS_WR;
class country_code name_of_former_variable_1;
 var mgZn_100kcal;
  output out = ZnN.out1zn_PFS_WR(keep = itemcode1 country_code name_of_former_variable_1 P_2_5 P_50 P_97_5) pctlpre=P_ pctlpts= 0 to 100 by 2.5;
   by itemcode1;
run;

data ZnN.out1_PFS_WR_zn(drop = P_2_5 P_50 P_97_5);
 set ZnN.out1zn_PFS_WR; 
  P_2_5_zn  = P_2_5;
  P_50_zn   = P_50; 
  P_97_5_zn = P_97_5;
run;
...
class country_code name_of_former_variable_1;
 var mgPhyt_100kcal;
  output out = ZnN.out1phy_PFS_WR(keep = itemcode1 country_code name_of_former_variable_1 P_2_5 P_50 P_97_5) pctlpre=P_ pctlpts= 0 to 100 by 2.5;
   by itemcode1;
run;

data ZnN.out1_PFS_WR_phy(drop = P_2_5 P_50 P_97_5);
 set ZnN.out1phy_PFS_WR; 
  P_2_5_phy   = P_2_5;
  P_50_phy    = P_50; 
  P_97_5_phy  = P_97_5;
run;
...
proc sort data = ZnN.out1_PFS_WR_phy; by country_code name_of_former_variable_1 itemcode1 ;run;
proc sort data = ZnN.out1_PFS_WR_zn ; by country_code name_of_former_variable_1 itemcode1 ;run;

data ZnN.Out1_Final_PFS_WR;
merge ZnN.out1_PFS_WR_zn(in=a) ZnN.out1_PFS_WR_phy (in=b)  ;
  by   country_code name_of_former_variable_1 itemcode1;
run;


data ZnN.Variable(drop = iteration -- mgPhyt_100kcal);
 set ZnN.Final_PFS_WR;
  if iteration = 1;
run;


proc sort data = ZnN.Variable;         by country_code name_of_former_variable_1 itemcode1 ;run;
proc sort data = ZnN.Out1_Final_PFS_WR; by country_code name_of_former_variable_1 itemcode1 ;run;

data ZnN.Out1_Final_PFS_WR;
merge ZnN.Variable(in=a) ZnN.Out1_Final_PFS_WR (in=b)  ;
  by   country_code name_of_former_variable_1 itemcode1;
run;
...
data ZnN.faofbs_krw_WR (rename =(name_of_former_variable_1 = year));
 set ZnN.faofbs_krw_WR ;
run; 

proc sort data=ZnN.faofbs_krw_WR;
by continent_code continent region_code region country_code country iso_code
   itemcode1 itemcodeB itemcode;
run; 

proc summary data=ZnN.faofbs_krw_WR;
...
output out=ZnN.faofbs_krw2005a_WR mean = ;
...
proc sort data=ZnN.faofbs_krw2005a_WR;
by continent_code continent region_code region country_code country iso_code  ;
run;

*Transpose data ;
proc transpose data=ZnN.faofbs_krw2005a_WR out = ZnN.faofbs_krw2005_WR;
by continent_code continent region_code region country_code country iso_code ;
id itemcode1;
...
data ZnN.faofbs_krw2005_WR;
set ZnN.faofbs_krw2005_WR;
calc_tot = SUM (OF _25112 -- _25202);
run;

proc sort data=ZnN.faofbs_krw2005_WR;
by continent_code continent region_code region country_code country iso_code  ;
run;

proc transpose data=ZnN.faofbs_krw2005_WR out = ZnN.faofbs_krwyear_WR;
by continent_code continent region_code region country_code country iso_code ;
id _name_;
var calc_tot;
run;
...
*****Merging pop_total data (from ZnN.wpp2010_b) with faofbs_year dataset;
...
proc sort data=ZnN.faofbs_krwyear_WR;
by country_code ;
run;

proc sort data=ZnN.wpp2010_b ;
by country_code ;
run;

data ZnN.faofbs_krwyear_WR (rename = (_name_ = nut_cap_d));
merge ZnN.faofbs_krwyear_WR ZnN.wpp2010_b (keep = country_code pop_tot1000 );
by country_code ;
run;
...
proc sort data=ZnN.wpp2010_znreq;
by continent_code continent region_code region country_code country iso_code ;
run;

data ZnN.faofbs_krwyear_WR;
merge ZnN.faofbs_krwyear_WR ZnN.wpp2010_znreq (keep=continent_code continent region_code region country_code country iso_code 
PrZn_mean);
by continent_code continent region_code region country_code country iso_code ;
run;
...
data ZnN.faofbs_krwdef_izincg_WR;
set ZnN.faofbs_krwyear_WR;
...
data ZnN.faofbs_krwdef_PFS_WR;
set  ZnN.faofbs_krwdef_izincg_WR;
run; 

proc datasets lib = ZnN;   delete faofbs_krwdef_izincg_WR; run; 


***Model PFS_NR***********************************************************************************************;

proc sort data = ZnN.Final_PFS_nr; by itemcode1; run;

proc univariate data = ZnN.Final_PFS_nr;
class country_code name_of_former_variable_1;
 var mgZn_100kcal;
  output out = ZnN.out1zn_PFS_nr(keep = itemcode1 country_code name_of_former_variable_1 P_2_5 P_50 P_97_5) pctlpre=P_ pctlpts= 0 to 100 by 2.5;
   by itemcode1;
run;

data ZnN.out1_PFS_nr_zn(drop = P_2_5 P_50 P_97_5);
 set ZnN.out1zn_PFS_nr; 
  P_2_5_zn  = P_2_5;
  P_50_zn   = P_50; 
  P_97_5_zn = P_97_5;
run;
...
class country_code name_of_former_variable_1;
 var mgPhyt_100kcal;
  output out = ZnN.out1phy_PFS_nr(keep = itemcode1 country_code name_of_former_variable_1 P_2_5 P_50 P_97_5) pctlpre=P_ pctlpts= 0 to 100 by 2.5;
   by itemcode1;
run;

data ZnN.out1_PFS_nr_phy(drop = P_2_5 P_50 P_97_5);
 set ZnN.out1phy_PFS_nr; 
  P_2_5_phy   = P_2_5;
  P_50_phy    = P_50; 
  P_97_5_phy  = P_97_5;
run;
...
proc sort data = ZnN.out1_PFS_nr_phy; by country_code name_of_former_variable_1 itemcode1 ;run;
proc sort data = ZnN.out1_PFS_nr_zn ; by country_code name_of_former_variable_1 itemcode1 ;run;

data ZnN.Out1_Final_PFS_nr;
merge ZnN.out1_PFS_nr_zn(in=a) ZnN.out1_PFS_nr_phy (in=b)  ;
  by   country_code name_of_former_variable_1 itemcode1;
run;


data ZnN.Variable(drop = iteration -- mgPhyt_100kcal);
 set ZnN.Final_PFS_nr;
  if iteration = 1;
run;


proc sort data = ZnN.Variable;         by country_code name_of_former_variable_1 itemcode1 ;run;
proc sort data = ZnN.Out1_Final_PFS_nr; by country_code name_of_former_variable_1 itemcode1 ;run;

data ZnN.Out1_Final_PFS_nr;
merge ZnN.Variable(in=a) ZnN.Out1_Final_PFS_nr (in=b)  ;
  by   country_code name_of_former_variable_1 itemcode1;
run;
...
data ZnN.faofbs_krw_nr (rename =(name_of_former_variable_1 = year));
 set ZnN.faofbs_krw_nr ;
run; 

proc sort data=ZnN.faofbs_krw_nr;
by continent_code continent region_code region country_code country iso_code
   itemcode1 itemcodeB itemcode;
run; 

proc summary data=ZnN.faofbs_krw_nr;
 var  kcal_cap_d kcalrczn kcalrcphyt extract1 extract2 extr_zn extr_phyt ferment1 ferm_phyt
...
output out=ZnN.faofbs_krw2005a_nr mean = ;
...
proc sort data=ZnN.faofbs_krw2005a_nr;
by continent_code continent region_code region country_code country iso_code  ;
run;

*Transpose data ;
proc transpose data=ZnN.faofbs_krw2005a_nr out = ZnN.faofbs_krw2005_nr;
by continent_code continent region_code region country_code country iso_code ;
id itemcode1;
var krw_mgZn_cd_25    krw_mgZn_cap_d    krw_mgZn_cd_97_5   krw_mgZn_cd_org
    krw_mgPhyt_cd_25  krw_mgPhyt_cap_d  krw_mgPhyt_cd_97_5 krw_mgPhyt_cd_org kcal_cap_d;
...
*Create calculated total of kcal_cap_d, mgZn_cap_d and mgphyt_cap_d based on individual food commodities;
data ZnN.faofbs_krw2005_nr;
set ZnN.faofbs_krw2005_nr;
calc_tot = SUM (OF _25112 -- _25202);
run;

proc sort data=ZnN.faofbs_krw2005_nr;
by continent_code continent region_code region country_code country iso_code  ;
run;

proc transpose data=ZnN.faofbs_krw2005_nr out = ZnN.faofbs_krwyear_nr;
by continent_code continent region_code region country_code country iso_code ;
id _name_;
var calc_tot;
run;
...
proc sort data=ZnN.faofbs_krwyear_nr;
by country_code ;
run;
...
data ZnN.faofbs_krwyear_nr (rename = (_name_ = nut_cap_d));
merge ZnN.faofbs_krwyear_nr ZnN.wpp2010_b (keep = country_code pop_tot1000 );
by country_code ;
run;
*Now we need to merge the population numbers with the faofbs_krwyear dataset from above;
...
data ZnN.faofbs_krwyear_nr;
merge ZnN.faofbs_krwyear_nr ZnN.wpp2010_znreq (keep=continent_code continent region_code region country_code country iso_code 
...
data ZnN.faofbs_krwdef_izincg_NR;
set ZnN.faofbs_krwyear_NR;
...
data ZnN.faofbs_krwdef_PFS_NR;
set  ZnN.faofbs_krwdef_izincg_NR;
run;

proc datasets lib = ZnN;   delete faofbs_krwdef_izincg_NR; run; 
quit;
