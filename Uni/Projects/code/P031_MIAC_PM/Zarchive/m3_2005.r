...
# m2_2005s<-m2_2005[,c("guid","day","m","lat_aod","long_aod","aod","predicted.m2")]
...
Final_pred_2005  = lme(newpred ~ meanPMmean ,random = list(guid= ~1 + meanPMmean ),control=lmeControl(opt = "optim"),data= m2mpm  )
...
#clean
keep(Final_pred_2005,m1_2005,mpmg,mod1table,fit2_1,fit2_2,fit2_3,fit2_4,fit2_5,fit2_6, sure=TRUE) 
gc()
...
# mpmg<-readRDS ("/home/zeltak/smb4k/ZUNISYN/ZUraid/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/FN000_RWORKDIR/mpmg_Temp2005.rds")
...
###############
#mpmg$mixpred<-  predict(Final_pred_2005,mpmg)
...
write.csv(m3d_agg,"/home/zeltak/smb4k/ZUNISYN/ZUraid/Uni/Projects/P031_MIAC_PM/3.Work/2.Gather_data/FN000_RWORKDIR/m3d_agg_2005.csv")
