...
libname pm 'Y:\Projects\P031_MIAC_PM\3.Work\2.Gather_data' ;
...
/*            DATAFILE= "Y:\Projects\P031_MIAC_PM\3.Work\2.Gather_data\FN015_withinkm\km100.dbf" */
/*			            DBMS=DBF   REPLACE;*/
/*						     GETDELETED=NO;*/
/*							 RUN; */
/* */
/**/
/**/
/*proc summary nway data=near_table_met;*/
/*class long_aod lat_aod ;*/
/*var guid;*/
/*output out=OUTPUTFILE mean=guid;*/
/*run; */

PROC EXPORT DATA= OUTPUTFILE
            OUTFILE= "Y:\ztmp\ttst.csv" 
			            DBMS=CSV REPLACE;
						     PUTNAMES=YES;
							 RUN;
...
proc append base = Final_100kmet2003 data = day&date force;
run;
