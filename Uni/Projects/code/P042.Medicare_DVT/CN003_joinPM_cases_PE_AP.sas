...
PROC IMPORT OUT= cases
            DATAFILE= "Z:\Projects\P042_Medicare_DVT\3.1.10.4.Work\2.Gather_data\FN002_Cases_guid_MIA\cases_PE_AP_clipped_XY.dbf" 
			            DBMS=DBF   REPLACE;
						     GETDELETED=NO;
							 RUN; 
...
PROC IMPORT OUT= ne_ses
            DATAFILE= "Z:\Projects\P042_Medicare_DVT\3.1.10.4.Work\2.Gather_data\FN002_calculate_SES\SES_NE_LU.dbf" 
			            DBMS=DBF   REPLACE;
						     GETDELETED=NO;
							 RUN; 

PROC IMPORT OUT= mia_ses
  DATAFILE= "Z:\Projects\P017.Medicare_MIA\3.1.10.1.Raw_data\SES\midatl_guid_cbg00wtdv2.csv" 
    DBMS=CSV REPLACE;
	  GETNAMES=YES;
	    DATAROW=2; 
		RUN;
...
PROC IMPORT OUT= x1
            DATAFILE= "Z:\Projects\P042_Medicare_DVT\3.1.10.4.Work\2.Gather_data\FN002_Cases_guid_MIA\cases_DVT_clipped_XY.dbf" 
			            DBMS=DBF   REPLACE;
						     GETDELETED=NO;
							 RUN; 
