...
libname poll "f:\Uni\Projects\3.1.0.TMP_PROJECTS\abby_BW\" ;
...
if gacalc < 30 then delete;
if gacalc > 42 then delete;
run; 
...
set bwcon;
end13_24 = totpreg - 91;
beg13_24 = end13_24 -83;
end13_24str = put(end13_24,$3.);
beg13_24str = put(beg13_24,$3.);
*test = 'l' || end13_24str;
str1 = 'pmnew_l'||beg13_24str;
str2 = 'pmnew_l'||end13_24str;
ma13_24 = mean(of str1 - str2);
run; 


proc means data=bwcon min max mean std nmiss;
var totpreg; 
run; 
