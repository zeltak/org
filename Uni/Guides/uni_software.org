...
** create documents with sphinx and RST 
This is what i used to genertae the pdfs for the Qgis course
*** installing depenenceis
to build pdf/html you need these 2:

http://docutils.sourceforge.net/rst.html

http://sphinx-doc.org/

plus the dependencies in the tutorial installs

to make sure you have all avilable install these (tested on debian)
...
then proceed onwards to clone and install qgis-tutor full project
*** install project
...
file:/media/NAS/Uni/Courses/Qgis/qgis-tutorials/source/static/common/bgu.png

the file that insert the cover page for each file is this:

file:/media/NAS/Uni/Courses/Qgis/qgis-tutorials/source/_templates/pdf_coverpage_en.tmpl

the file to edit author name etc is here:

file:/media/NAS/Uni/Courses/Qgis/qgis-tutorials/source/conf.py
